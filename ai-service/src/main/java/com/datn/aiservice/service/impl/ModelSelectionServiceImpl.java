...
public class ModelSelectionServiceImpl implements ModelSelectionService {
    ModelConfigurationRepo modelConfigurationContracts;

    @Override
    public ModelMinimalResponseDto getModelsConfiguration() {
    ...
    public boolean isModelEnabled(String modelName) {
        return modelConfigurationContracts.isModelEnabled(modelName);
    }
}
