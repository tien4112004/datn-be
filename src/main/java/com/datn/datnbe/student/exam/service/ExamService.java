...
public class ExamService implements ExamApi {
    ...
    @Override
    @Transactional
    public Flux<String> generateQuestions(UUID examId, GenerateQuestionsRequest request, UUID teacherId) {
        ...
        return examGenerationApiClient.generateQuestions(request).doOnComplete(() -> {
