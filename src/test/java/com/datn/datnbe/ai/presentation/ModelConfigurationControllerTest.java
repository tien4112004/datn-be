...
@WebMvcTest(value = ModelConfigurationController.class, excludeAutoConfiguration = {SecurityAutoConfiguration.class,
...
class ModelConfigurationControllerTest {
    ...
    // ===============================
    // Tests for GET /api/models?modelType=TEXT
    // ===============================
    ...
    // ===============================
    // Tests for GET /api/models?modelType=IMAGE
    // ===============================
