...
public class PresentationControllerIntegrationTest {
    ...
    // SlideBackgroundDto.builder().type("color").color("#ffffff").build();
    //
    ...
    //
    //		SlideDto slide =
    // SlideDto.builder().id("slide-1").elements(List.of(textElement)).background(background)
    //				.build();
    //
    ...
    //				.id("complex-slide-1")
    //				.elements(Arrays.asList(request.getSlides().getFirst().getElements().getFirst(),
    // shapeElement,
    //						imageElement))
    ...
    //				.build();
    //
    //		SlideDto slideWithNulls =
    // SlideDto.builder().id("slide-with-nulls").elements(List.of(elementWithNulls))
    //				.build();
    //
    ...
    //						containsInAnyOrder("Integration Test Presentation 1",
    ...
    //				.build();
    //
    //		presentationRepository.saveAll(
    //				List.of(matchingPresentation1, matchingPresentation2, nonMatchingPresentation));
    //
    //		// When & Then
    ...
    //				.andExpect(jsonPath("$.data", hasSize(2)))
    //				.andExpect(jsonPath("$.data[*].title",
    //						containsInAnyOrder("Important Business Presentation",
    ...
    //		mockMvc.perform(get("/api/presentations").param("filter", "test")
    //				.contentType(MediaType.APPLICATION_JSON))
    //				.andExpect(status().isOk())
    ...
    //				.build();
    //
    //		presentationRepository.saveAll(List.of(oldestPresentation, middlePresentation,
    // newestPresentation));
    //
    //		// Test ascending sort
    //		mockMvc.perform(get("/api/presentations").param("sort",
    // "asc").contentType(MediaType.APPLICATION_JSON))
    //				.andExpect(status().isOk())
    ...
    //		mockMvc.perform(get("/api/presentations").param("sort",
    // "desc").contentType(MediaType.APPLICATION_JSON))
    //				.andExpect(status().isOk())
    ...
    //		// When & Then
    //		mockMvc.perform(
    //				get("/api/presentations").param("filter", "nonexistentfilter")
    //						.contentType(MediaType.APPLICATION_JSON))
    //				.andExpect(status().isOk())
    //				.andExpect(jsonPath("$.data", hasSize(0)))
    ...
    //				.andExpect(jsonPath("$.data", hasSize(2)))
    //				.andExpect(jsonPath("$.data[*].title",
    //						hasItems("Untitled Presentation", "Direct DB Presentation")));
    //
    //		// Test collection endpoint with filter
    //		mockMvc.perform(get("/api/presentations").param("filter", "Direct")
    //				.contentType(MediaType.APPLICATION_JSON))
    //				.andExpect(status().isOk())
    //				.andExpect(jsonPath("$.data", hasSize(1)))
