...
import com.datn.datnbe.document.infrastructure.repository.PresentationRepository;
...
public class PresentationControllerIntegrationTest {
    ...
    void setUp() {
        ...
        SlideDto slide = SlideDto.builder().id("slide-1").elements(List.of(textElement)).background(background)
                .build();
    ...
    void createPresentation_WithMultipleSlideTypes_ShouldHandleAllTypes() throws Exception {
        ...
        SlideDto complexSlide = SlideDto.builder()
                .id("complex-slide-1")
                .elements(Arrays.asList(request.getSlides().getFirst().getElements().getFirst(), shapeElement,
                        imageElement))
    ...
    void createPresentation_WithNullValues_ShouldHandleGracefully() throws Exception {
        ...
        SlideDto slideWithNulls = SlideDto.builder().id("slide-with-nulls").elements(List.of(elementWithNulls))
                .build();
