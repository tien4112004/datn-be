...
-- Insert: HOA MAI VÀNG
INSERT INTO contexts (grade, subject, title, content, author) VALUES 
...
Mai thích hoa đại, hoa nhài, hoa mai, nhất là hoa mai vàng.', NULL);
...
- Trí khôn của ta đây! Trí khôn của ta đây!', NULL);

-- Insert: CON QUẠ THÔNG MINH
INSERT INTO contexts (grade, subject, title, content, author) VALUES 
(1, 'TV', 'CON QUẠ THÔNG MINH', 'Có một con quạ khát nước. Nó tìm thấy một cái lọ nước. Nhưng nước trong lọ quá ít, cổ lọ lại cao, nó không sao thò mỏ vào uống được. Nó nghĩ ra một cách: nó lấy mỏ gắp từng viên sỏi bỏ vào lọ. Một lúc sau, nước dâng lên, quạ tha hồ uống.', NULL);

-- Insert: NHỚ BÀ
INSERT INTO contexts (grade, subject, title, content, author) VALUES 
(1, 'TV', 'NHỚ BÀ', 'Bà vẫn ở quê. Bé rất nhớ bà.

Bà đã già, mắt đã loà, thế mà bà đan lát, cạp rổ, cạp rá bà tự làm cả. Bà vẫn rất ham làm.', NULL);
...
(theo Trần Hoài Dương)', 'Trần Hoài Dương');

-- Insert: TẤM CÁM
INSERT INTO contexts (grade, subject, title, content, author) VALUES 
(1, 'TV', 'TẤM CÁM', 'Tấm và Cám là hai chị em cùng cha khác mẹ! Ngày kia, dì ghẻ bảo hai chị em ra đồng xúc tép. Tấm siêng năng bắt được giỏ đầy. Cám ham chơi chẳng bắt được gì.', NULL);
...
Sáng sáng, bà vẫn cài hoa lan cho bé. Bé thích lắm.', NULL);
...
Nay ở Thanh Hóa vẫn còn đền thờ Bà Triệu và lưu truyền những câu ca về bà.', NULL);
...
Hằng năm, khách du lịch từ các miền đổ về bãi biển Nha Trang tham quan và nghỉ mát.', NULL);
...
Ngày cô đến, tu hú và sẻ con đều ấp úng: Thưa cô…..làm tổ khó quá ạ! Đến tổ chích chòe, cô khen: Tổ của con vừa chắc vừa đẹp. Cô tặng chích chòe quyển sách có nhiều tranh ảnh. Tu hú và sẻ con đều ân hận. Chúng hứa với cô sẻ chăm học để làm được tổ.', NULL);
...
- Vì con thương bà. Trời lạnh thế mà bà không được ở nhà. Con mua búp bê cho bà vui.', NULL);
...
Bé treo nón, mặt tỉnh khô, bẻ một nhánh trâm bầu làm thước. Mấy đứa em chống hai tay ngồi nhìn chị. Làm như cô giáo, Bé đưa mắt nhìn đám học trò, tay cầm nhánh trâm bầu nhịp nhịp lên tấm bảng.', 'Nguyễn Thi');
...
Như một con người biết buồn vui, biển lúc tẻ nhạt, lạnh lùng, lúc sôi nổi, hả hê, lúc đăm chiêu, gắt gỏng.', 'Vũ Tú Nam');
...
Gấu con chọn quả lê to thứ ba cho Gấu em. Gấu em thích quá , ôm lấy quả lê. Hai anh em cùng nhau vui vẻ cười vang khắp nhà.', 'Báo Giáo dục Thành phố Hồ Chí Minh');
...
Được vui chơi cùng ông bà sẽ giúp bé thêm lớn khôn.', 'Shi-mu-ra Yo-ko');
...
Trên mấy cây cao cạnh nhà, ve đua nhau kêu ra rả. Ngoài suối, tiếng chim cuốc vọng vào đều đều. Bản làng đã thức giấc. Đó đây, ánh lửa hồng bập bùng trên các bếp. Ngoài bờ ruộng đã có bước chân người đi, tiếng nói chuyện rì rầm, tiếng gọi nhau í ới.', 'Hoàng Hữu Bội');
...
Mẹ khen năm anh em rất ngoan, biết giúp đỡ bố mẹ.', NULL);
...
- Có bao giờ...có bao giờ Chủ tịch nước lại tới thăm nhà chúng con. Được thấy Bác đến nhà, con cảm động quá!', 'Phạm Thị Sửu – Lê Minh Hà');
...
Có chú nhảy quá đà, vọt lên cả lên boong tàu. Anh chiến sĩ vội chạy lại, vuốt ve chỗ đau rồi thả chú cá xuống nước. Cả đàn cá heo quay qua quay lại cạnh con tàu, nhảy lên một lần cuối như để cảm ơn rồi lặn xuống dưới biển.', NULL);
...
Người đàn ông trìu mến nhìn cậu bé và cùng cậu cứu những con sao biển.', 'Hạt giống tâm hồn – Phép màu có giá bao nhiêu?');
...
Hai đồng chí kia lại phải san đều các thứ vào ba chiếc ba lô.', '117 CHUYỆN KỂ VỀ TẤM GƯƠNG ĐẠO ĐỨC HỒ CHÍ MINH');
...
Chiều rồi đêm xuống, trẻ con bên hàng xóm bập bùng trống ếch rước đèn. Lúc đó, Tâm lại thấy không thích mâm cỗ của mình bằng đám rước đèn. Tâm bỏ mâm cỗ chạy đi xem.', 'Nguyễn Thị Ngọc Tú');
...
Chiều chiều, chúng tôi ra ngồi gốc đa hóng mát. Lúa vàng gợn sóng. Xa xa, giữa cánh đồng, đàn trâu ra về, lững thững từng bước nặng nề. Bóng sừng trâu dưới ánh chiều kéo dài, lan giữa ruộng đồng yên lặng.', 'NGUYỄN KHẮC VIỆN');
...
Chiền chiện có mặt ở khắp nơi, nhất là những vùng trời đất bao la. Khi chiều thu buông xuống, lúc đã kiếm ăn no nê trên bãi đồng, chiền chiện vụt bay lên như viên đá ném vút lên trời. Theo cùng tiếng chim bay lên, từ không trung vọng xuống tiếng hót trong sáng diệu kì, giọng ríu ran đồ hồi, âm điệu hài hòa, quyến rũ…Tiếng chim là tiếng nói của sứ giả mặt đất gửi tặng trời. Rồi, tiếng chim lại là tiếng nói của thiên sứ gửi lời chào mặt đất.', 'Ngô Văn Phú');
...
Cắn một miếng bánh, Tuấn bất ngờ bởi vị ngọt và hương thơm rất lạ. Tuấn sẽ gọi điện xin lỗi ông Tư, mong hè sẽ về thăm ông Tư và được ông cho ăn bánh tổ.', 'Kim Hài');
...
Đẹp thay lúc thu sang!', 'Trần Lê Văn');
...
Ban đêm trên bãi thả diều thật không còn gì huyền ảo hơn. Có cảm giác diều đang trôi,… người lớn về dần, bỏ mặt chúng tôi với bầu trời, một tấm thảm nhung khổng lồ. Chúng tôi chỉ còn trăng, sao và những cánh diều.', 'TẠ DUY ANH');
...
Thế là cuộc thi bắt đầu. Chỉ ít phút sau, bác đã bỏ xa cô gái cấy giỏi nhất vài mét. Lúa bác cấy vừa đều vừa thẳng hàng. Thấy vậy, ai nấy đều trầm trồ, thán phục nhà bác học nói và làm đều giỏi.', 'Nguyễn Hoài Giang');
...
Từ đó, năm nào Thủy Tinh cũng dâng nước đánh Sơn Tinh, gây lũ lụt khắp nơi nhưng lần nào Thủy Tinh cũng chịu thua.', 'TRUYỆN CỔ VIỆT NAM');
...
- Mẹ ơi, con hiểu rồi. Công việc của các bác nông dân vất vả quá mẹ nhỉ?', 'Những câu chuyện hay, những bài học quỹ');
...
Đó là tổ tiên của các dân tộc anh em trên đất nước ta ngày nay.', 'Truyện cổ Khơ Mú');
...
Rồi đến Rằm tháng Bảy. Dòng sông Cửu Long đã no đầy, lại tràn qua bờ, tràn qua cả mặt đường. Nước trong ao hồ, trong đồng ruộng của mùa mưa hòa lẫn với nước dòng sông Cửu Long.', 'Nguyễn Quang Sáng');
...
Rừng vàng: đầy quặng, gỗ.', 'Phạm Hổ');
...
Cây gạo già mỗi năm lại trở lại tuổi xuân, càng nặng trĩu những chùm hoa đỏ mọng và đầy tiếng chim hót.', 'Vũ Tú Nam');
...
Hoa kết thành chùm, bông hoa lớn che chở cho nụ hoa bé nhỏ. Chúng cũng đẹp như tình chị em của Nết và Na. Dân làng đặt tên cho loài hoa ấy là hoa tỉ muội.', 'Trần Mạnh Hùng');
...
Bác Rùa cao tuổi nhất, hiểu biết nhất vùng hồ này. Nhờ có bốn chân, bác Rùa lên được bờ, biết nhiều cảnh, nhiều chuyện trên cạn. Bác rất tốt bụng, hay giúp đỡ người khác.', NULL);
...
Từ những cành sấu non bật ra những chùm hoa trắng muốt, nhỏ như những chiếc chuông tí hon. Hoa sấu thơm nhẹ. Vị hoa chua chua thấm vào đầu lưỡi, tưởng như vị nắng non của mùa hè mới đến vừa đọng lại.', 'Băng Sơn');
...
Cô hài lòng, bảo hai em về chỗ rồi tiếp tục giảng bài.', 'Nguyễn Văn Thịnh');
...
Làm đồ chơi khéo tay.', 'Phạm Anh Xuân');
...
Nếu con lười biếng, dù cha cho một trăm hũ bạc cũng không đủ. Hũ bạc tiêu không bao giờ hết chính là đôi bàn tay con.', 'Truyện cổ tích Chăm');
...
Về đến nhà, hai anh em thú nhận mọi chuyện với mẹ. Sẻ mẹ nhẹ nhàng bảo: “Không sao, hai con biết nhận lỗi là tốt. Nhưng giá như hai con nhớ lời mẹ dặn thì tối nay nhà mình đã có ngô để ăn rồi.”.', NULL);
...
Không đành lòng cô liền dùng tay xé nhẹ dần từng cánh hoa lớn thành những cánh hoa nhỏ và bông hoa cũng theo đó mà nhiều cánh dần lên nhiều đến mức không còn đếm được nữa. Từ đó người đời gọi bông hoa ấy là bông hoa cúc trắng để nói về lòng hiếu thảo của cô bé đó dành cho mẹ mình.', NULL);
...
Trăng lên. Gió mơn man dìu dịu. Dòng sông trăng gợn sóng. Con thuyền bồng bềnh. Đêm nằm trên dòng Hương thơ mộng để nghe ca Huế, với tâm trạng chờ đợi rộn lòng.', 'Hà Ánh Minh');
...
Trong hồ rộng, sen đang lụi dần. Những chiếc lá to như cái sàng màu xanh sẫm đã quăn mép, khô dần. Họa hoằn mới có vài lá non xanh, nho nhỏ mọc xòe trên mặt nước. Gương sen to bằng miệng bát, nghiêng nghiêng như muốn soi chân trời. Tiếng cuốc kêu thưa thớt trong các lùm cây lau sậy ven hồ. Dường như chúng mỏi miệng sau một mùa hè kêu ra rả và bây giờ muốn nghỉ ngơi cho lại sức...', 'Nguyễn Văn Chương');
...
Chồi cây giống như cuộc đời của một con người. Khi mới nứt nanh, có một màu tím biếc thật dễ thương như cu con mới lọt lòng. Những lá non mới chui từ lòng mẹ chui ra, chúng còn yếu ớt, mềm mại non tơ, ngơ ngác với thiên nhiên. Hằng ngày được nắng, gió luyện rèn, chả mấy chốc chúng từ màu tím biếc đã chuyển sang màu xanh nõn. Lúc này, lá cây cũng giống như bàn tay em bé, vẫy vẫy theo gió xuân nhè nhẹ. Và tháng năm về, khi tiếng ve cưa miết vào không gian, cũng là lúc lá cây chuyển sang màu xanh đậm. Lúc này, lá cây ở thời kì sung sức nhất của cuộc đời mình. Từ những nách lá đã này ra những chùm hoa đỏ chói, vàng sáng, tím lịm như nhung ... rồi kết quả. Mùa thu đến, cũng là lúc lá cây về già, gân guốc nổi lên để chống chọi với những đợt gió táp, sương sa. Mùa đông, lá cây như những cụ già lụ khụ, úa vàng, máu còn úa đỏ trên mặt lá đã phải lìa cành để nhường lại cho cây ấp ủ những chồi biếc mai sau.', NULL);
...
Ngày nay, khắp núi rừng Tây Nguyên đâu đâu cũng có sông hồ. Dân làng bảo: những dấu chân già làng Voi đánh nhau với Cá Sấu tạo thành hồ. Còn những dấu vết kéo gỗ ngang dọc hoá thành sông, suối.', 'Truyện cổ Tây Nguyên');
...
- Các cháu có một tình bạn thật đẹp.', NULL);
...
Thanh kiếm và hoa hồng hiểu ra, chúng rối rít cảm ơn nhà thông thái. Cả hai bắt tay nhau thân thiện và không bao giờ cãi nhau nữa.', 'Truyện cổ tích Ả Rập');
...
Về sau, cậu bé Giêm-mi may mắn ấy trở thành một nhà kinh doanh rất thành đạt như mơ ước của mình. Đến tận khi qua đời, theo tôi biết, Giêm-mi vẫn không biết ai là người giúp đỡ ông chữa bệnh hồi đó… Nhiều năm trôi qua, tôi luôn ghi nhớ lời ông chủ đã nói với bố tôi: “Cho đi mà không cần phải nhận lại sẽ là niềm vui lâu dài”.', 'Bích Thủy');
...
Nghe vậy, cây sồi ngậm ngùi, xấu hổ. Nó không còn dám coi thường cây sậy bé nhỏ yếu ớt nữa.', 'Truyện ngụ ngôn nước ngoài');
...
Khi ấy, tôi chợt hiểu rằng: cả tôi nữa, tôi cũng vừa nhận được chút gì của lão.', 'Tuốc-ghê-nhép');
...
Có những khó khăn chúng ta có thể vượt qua được bằng chính sức lực của mình. Nhưng có những thử thách lớn mà chúng ta chỉ có thể vượt qua nhờ tình yêu thương, đồng lòng gắn bó và chia sẻ với nhau như những cành nho nhỏ bé kia.”', 'Hạt giống tâm hồn');
...
Nghe xong câu chuyện, người chồng vội chạy ngay xuống bãi biển mong có thể nói một lời xin lỗi và một lời biết ơn chân thành, nhưng bà cụ đã đi xa rồi. Bóng bà chỉ còn là một chấm nhỏ trên bãi biển vắng người khi chiều đang xuống…', 'Internet Những câu chuyện cảm động – Diễn đàn làm cha mẹ');
...
- Mẹ ơi!… – Chiếc lá thầm thì điều gì đó với Cây Bàng.', 'Quỳnh Trâm');
...
Sư Tử khỏi đau, hối hận vì đã đối xử không tốt với Kiến. Sư Tử vội vàng xin lỗi Kiến và từ đó coi Kiến là bạn thân nhất trên đời.', 'Truyện cổ dân tộc Lào');
...
– Tôi không bịa tí nào đâu! Mãi mãi tôi kính trọng những chiếc lá bình thường như thế. Chính nhờ họ mới có chúng tôi: những hoa, những quả, những niềm vui mà bạn vừa nói trên kia.', 'Trần Hoài Dương');
...
- Mình sẽ không bao giờ làm thế nữa.', 'NGUYỄN THỊ LIÊN');
...
Khi trở ra, Quốc Toản xoè tay cho mọi người xem cam quý. Nhưng quả cam đã nát từ bao giờ.', 'Nguyễn Huy Tưởng');
...
- Tớ phải cảm ơn cậu mới đúng. Vì cậu đã cho tớ cơ hội được giúp đỡ người bạn tớ yêu quý.', 'Những hạt giống tâm hồn');
...
Thế rồi vua mở khoa thi. Chú bé thả diều đỗ Trạng nguyên. Ông Trạng khi ấy mới có mười ba tuổi. Đó là Trạng nguyên trẻ nhất của nước Nam ta.', 'Trinh Đường');
...
Hơn bốn mươi năm khổ công nghiên cứu, tìm tòi, Xi-ôn-cốp-xki đã thực hiện được điều ông hằng tâm niệm: "Các vì sao không phải để tôn thờ mà là để chinh phục.".', 'Lê Nguyên Long – Phạm Ngọc Toàn');
...
Tôi vụt hiểu tất cả: Vì sao cây bàng không rụng lá.', 'Phong Thu');
...
Chim Sẻ nói cảm ơn liên hồi rồi cúi xuống mổ dồn dập.', 'Báo Nhi đồng số 8/2009');
...
Nghe xong, chú nhỏ ùa tới ôm chầm lấy mẹ, nước mắt lưng tròng. Người cậu run lên vì xúc động. Đức hy sinh của mẹ thanh cao quá! Cả ngày, chú bé cứ nắm riết lấy mẹ không rời.', 'Những hạt giống tâm hồn');
...
Đó là thời khắc quý báu nhất trong đời tôi. Hai ngày sau, bố tôi đột ngột bị một cơn đau tim và vẫn còn nằm trong bệnh viện cho đến bây giờ. Nếu như tôi trì hoãn bộc lộ với bố, có lẽ tôi không còn cơ hội nào nữa”.', 'Đen-nít E. Man-nơ-rinh');
...
Bố mẹ Nết rơm rớm nước mắt khi biết nhà trường sẽ đặc cách cho Nết vào học lớp Hai. Còn Nết, cô bé đang hình dung cách cô giáo cùng các bạn nhỏ xúm xít đầy chiếc xe lăn.', 'Tâm huyết nhà giáo');
...
Sau này, tôi đã viết thêm nhiều những cuốn sách, nhưng cuốn sách đầu tay của tôi là dành tặng riêng bà, dành tặng cho người đầu tiên khơi dậy những khả năng tiềm ẩn trong tôi, là người đã tạo cho tôi tự tin để thể hiện chính mình trên những trang viết.', 'Nhã Khanh');
...
Riêng tôi, tôi nhớ cốc hoa tóc tiên trên bàn thầy giáo cách đây mấy chục năm ở một cái thôn hẻo lánh, hoa có màu cánh sen nhẹ, lá thì xanh biếc, còn hương thơm thì thoảng nhẹ và ngon lành như một thứ bánh. Thầy giáo tôi đã mất. Nhưng chắc ở trên trời, thầy vẫn có cốc hoa tóc tiên tinh khiết của mình...', 'Băng Sơn');
...
Chim em ngoan ngoãn rúc vào cánh mẹ thay cho lời vâng ạ. Chim anh cũng ôm lấy em rồi cùng mẹ dìu em lên tổ.', 'Phong Thu');
...
– Mỗi buổi sáng sớm, khi mặt trời bắt đầu sưởi ấm vạn vật, muôn loài đều hân hoan hát ca. Nhưng mỗi loài đều có tiếng hát của riêng mình. Có biết lắng nghe nhau mới hiểu được tiếng hát của nhau, các cháu ạ.', 'Truyện nước ngoài');
...
Liên tục cải tiến phát minh của mình, đến năm 43 tuổi, Phun-tơn đã chế tạo ra con tàu sử dụng động cơ hơi nước đầu tiên trên thế giới.', '100 câu chuyện hay dành cho bé trai');
...
Sa Pa quả là món quà tặng diệu kì mà thiên nhiên dành cho đất nước ta.', 'NGUYỄN PHAN HÁCH');
...
Bất giác, An cảm thấy hối hận vô cùng. An nhớ lại ánh mắt buồn của mẹ khi cậu ném chiếc áo khoác xuống đất. Bố chỉ nhẹ nhàng: “Con có hiểu không? Cuộc đời này còn nhiều người thiệt thòi lắm. Hãy biết trân trọng thứ mà mình đang có.”', NULL);
...
Sau câu chuyện kì lạ ấy, ở nhiều thành phố Hi Lạp và La Mã đã xuất hiện những đồng tiền khắc hình một con cá heo cõng người trên lưng. Có lẽ đó là đồng tiền được ra đời để ghi lại tình cảm yêu quý con người của loài cá thông minh.', NULL);
...
Chúng cứ hát mãi, hát mãi, hát mãi cho đến lúc những ngọn khói tan biến vào không gian mênh mông…', 'Nguyễn Trọng Tạo');
...
Rừng say ngây và ấm nóng. Thảo quả như những đốm lửa hồng, ngày qua ngày lại tiếp thêm nhiều ngọn mới, nhấp nháy vui mắt.', 'Ma Văn Kháng');
...
- Sự trung thực của con đáng giá gấp ngàn lần cây anh đào đó con ạ.', 'Vạn điều hay');
...
Nhiều năm sau, khi cô bé đã trở thành một họa sĩ nổi tiếng với những bức tranh về thiên nga, cô vẫn nhớ mãi người bạn đầu tiên đã cho cô niềm tin và hy vọng để theo đuổi ước mơ của mình.', 'Nguyễn Thu Hương');
...
Đối với tôi, mùa thu luôn gợi lên một cảm giác thân thuộc, như thể mùa thu đã ở trong tôi từ rất lâu rồi, từ những ngày thơ ấu. Cứ mỗi lần mùa thu đến, tôi lại cảm thấy yêu thêm những gì giản dị, bình yên xung quanh mình.', 'Nguyễn Quang Sáng');
...
Cuối năm học, khu vườn của lớp Nam đã đạt giải nhất cuộc thi. Nhưng với Nam, phần thưởng lớn nhất chính là niềm vui khi thấy các bạn trong trường cũng bắt đầu yêu thích và học cách chăm sóc cây cối. Từ đó, trường học của Nam luôn xanh tươi và tràn ngập những nụ cười.', 'Tạp chí Thiếu nhi Việt Nam');
...
Mỗi ngày kết thúc, họ thu dọn dụng cụ, nhìn lại những khu vực đã hoàn thành và cảm thấy vui vì đã đóng góp công sức vào việc tạo ra một môi trường sống tốt đẹp hơn cho mọi người.', 'Sách Cuộc sống mỗi ngày');
...
Bố mẹ và em trai nép sau gốc chà là xúc động nhìn Lê, mắt ướt nhòe đi.', 'Nhung Ly');
...
Mọi việc chẳng phải lúc nào cũng dễ dàng cả đâu, nhưng rất đáng công để bạn phải nỗ lực đấy!', 'Xti-vơ Gu-đi-ơ');
...
Tôi chính là cô bé thuở ấy và kể từ lúc đó, mỗi lần anh trêu là "bé bự”, tôi chỉ phì cười. Tôi biết là anh tôi yêu thương tôi. Anh không cần phải đối đầu với một con trâu càn để chứng minh lòng yêu thương em của mình. Nhưng tôi vẫn nhớ cái ngày mà anh tôi đã chứng tỏ lòng thương yêu ấy.', 'Diana L. James (Hải Châu dịch)');
...
Ngày hội kết thúc, bố và tôi bước ra khỏi cổng trường trong những ánh mắt ngưỡng mộ. Bố – người hùng đã không chỉ chiếm được trái tim của tôi, mà còn của mọi người xung quanh. Tôi tự hào về bố. Đó là một ngày hạnh phúc mà tôi sẽ không bao giờ quên.', 'Mai Hiền');
...
Từ đó, thiên đường luôn khoác trên mình một chiếc áo nhiều màu rực rỡ, vật kỉ niệm thiêng liêng của biết bao loài chim bạn bè.', 'Trần Hoài Dương');
...
Chỉ trong ít phút ngắn ngủi, câu chuyện chiếc đồng hồ của Bác đã khiến cho ai nấy đều thấm thía, tự đánh tan được những thắc mắc riêng tư.', 'Sách Bác Hồ kính yêu');
...
Nói xong, Mồ Côi trả hai đồng bạc cho bác nông dân rồi tuyên bố kết thúc phiên xử. Bác nông dân thở phào nhẹ nhõm, còn ông chủ quán đành lẳng lặng ra về, không dám kêu ca gì.', 'Truyện dân gian dân tộc Nùng');
...
Rồi các bạn bắt đầu vẽ tranh, tô lên đó những màu sắc rực rỡ và hoàn thiện chúng. Ai nấy cũng đều vui sướng. Sau giờ học, các bạn nhận ra rằng nghệ thuật sẽ mang lại sắc màu cho cuộc sống.', 'Hồng Thư');
...
Chúng em hi vọng sẽ được đi trải nghiệm thêm nhiều làng nghề truyền thống hơn nữa.', 'Hồng Thư');
...
Thầy vừa dứt lời, cả lớp vỗ tay rào rào thán phục và cảm ơn bài học đáng quý của thầy.', 'Nhung Ly');
...
Để làm được những việc nhọc nhằn đó, Người đã cho họ những giọt nước mắt để rơi, để họ sử dụng bất cứ lúc nào và đấy là điểm yếu duy nhất của họ. Khi con thấy họ khóc, hãy nói với họ con yêu họ biết bao và nếu họ vẫn khóc, con hãy làm trái tim họ được bình yên.”', 'Võ Đức Duy');
...
Mẹ dịu dàng nắm tay An, âu yếm nhìn con: “Ừ! Chỉ cần con yêu thích và cố gắng làm tốt công việc của mình, thì nghề nào cũng quý con ạ.”. Thế rồi, hai mẹ con vui vẻ rảo bước trong công viên đầy nắng.', 'Nhung Ly');
...
Tiếng vỗ tay làm Phương bừng tỉnh. Mọi con mắt đổ dồn về phía nó. Nó cúi gằm mặt xuống, cảm thấy ngượng nghịu và xấu hổ. Vậy mà nó đã giận mẹ!', 'Nguyễn Thị Hoan');
...
- Quả có chuyện như vậy. Xin Bệ hạ quở trách thần và ban thưởng cho người nói thật.', 'Đại Việt sử kí toàn thư');
...
Còn bây giờ đêm đã về khuya. Các anh chị công nhân dọn dẹp, quét đi bụi bẩn, lá rụng và tôi trở nên sạch sẽ, thoáng mát. Tôi vươn vai ngáp dài. Chắc cũng phải ngủ một chút cho một ngày mới đầy vui vẻ sắp bắt đầu. Sáng mai, tôi sẽ lại được sống một ngày ngập tràn tình yêu và hạnh phúc!', 'Hà Thu');
...
Biết tin, cha mẹ Lan chạy đến. Cả hai cô chú ôm chầm lấy Vịnh, xúc động không nói nên lời.', 'Tô Phương');
...
Lúc đó, Sơn cảm thấy lòng mình ấm áp lạ thường, dù gió mùa đông bắc vẫn thổi từng cơn lạnh buốt.', 'Thạch Lam');
...
Tôi rất thích chim gáy. Con chim gáy phúc hậu và chăm chỉ, con chim gáy mơ màng, con chim gáy no ấm của mùa gặt hái tháng Mười.', 'Tô Hoài');
...
Chiều chiều, tôi thường ra đầu bản nhìn lên những vòm cây trám ngóng chim về. Người bản tôi nhìn lên cái ô xanh treo lơ lửng lưng trời ấy mà biết sức gió. Xa quê đã ngót chục năm trời, tôi vẫn nhớ da diết những cây trám đen ở đầu bản.', 'Vi Hồng, Hồ Thủy Giang');
...
Mong bạn hãy giữ gìn những dấu câu của mình, bạn nhé!', 'Hồng Phương');
...
Không, cây chuối mẹ khẽ khàng ngả hoa sang cái khoảng trống không có đứa con nào.', 'Phạm Đình Ân');
...
"Con biết không, trồng cây giống như nuôi dưỡng ước mơ. Cần có kiên nhẫn, chăm chỉ và tình yêu." – Ông nội nói.', 'Minh Ngọc');
...
INSERT INTO contexts (grade, subject, title, content, author) VALUES 
(2, 'TV', 'CON QUẠ THÔNG MINH', 'Có một con quạ khát nước. Nó tìm thấy một cái lọ nước. Nhưng nước trong lọ quá ít, cổ lọ lại cao, nó không sao thò mỏ vào uống được. Nó nghĩ ra một cách: nó lấy mỏ gắp từng viên sỏi bỏ vào lọ. Một lúc sau, nước dâng lên, quạ tha hồ uống.', NULL);

-- Duplicate: TẤM CÁM (From Grade 1 to 2)
INSERT INTO contexts (grade, subject, title, content, author) VALUES 
(2, 'TV', 'TẤM CÁM', 'Tấm và Cám là hai chị em cùng cha khác mẹ! Ngày kia, dì ghẻ bảo hai chị em ra đồng xúc tép. Tấm siêng năng bắt được giỏ đầy. Cám ham chơi chẳng bắt được gì.', NULL);
...
Cứ thế lần lượt các kiến con hôn truyền nhau và nhờ thế Kiến Mẹ có thể chợp mắt mà vẫn âu yếm được cả đàn con.', 'Chuyện của mùa hạ');
...
Người kia xấu hổ quá, xin lỗi bạn vì mình đã bỏ bạn lại chạy trốn.', 'Ngụ ngôn');
...
Mỗi chúng ta đều có thể sống như cái chậu nứt: hãy biết tận dụng "vết nứt" của mình.', 'Hạt giống tâm hồn');
...
Các em vội đáp: – Thưa cụ, cụ đừng bận tâm ạ. Thầy giáo và cha mẹ thường dạy chúng cháu phải giúp đỡ người già và trẻ nhỏ.', 'Văn lớp 3');
...
Lò rèn của Rít đỏ lửa, ngày đêm vang tiếng búa đe. Sống giữa sự quý trọng của dân làng, Rít thấy sống có ích mới là điều đáng ước mơ.', 'Truyện cổ Ba-na');
...
Trái cây thơm ngon, ở vườn nhà cậu, ai cũng thích. Họ đem hạt gieo trồng khắp nơi và gọi đó là cây Vú Sữa.', 'Ngọc Châu');
...
Thằng Hiển ngọng líu, nói không kịp hai đứa lớn. Cái Anh hai má núng nính, ngồi gọn tròn như củ khoai, bao giờ cũng giành phần đọc xong trước. Cái Thanh mở to đôi mắt hiền dịu nhìn tấm bảng, vừa đọc vừa mân mê mớ tóc mai.', 'Nguyễn Thi');
...
Lan ân hận quá. Em muốn ngồi dậy xin lỗi mẹ và anh, nhưng lại xấu hổ vì mình đã vờ ngủ. Áp mặt xuống gối, em mong trời mau sáng để nói với mẹ: "Con không thích chiếc áo ấy nữa. Mẹ hãy mua áo ấm cho cả hai anh em".', 'Từ Nguyên Thạch');
...
Thuyên cảm động. Đồng nắm tay người thanh niên, mắt rớm lệ. Ba người cùng im lặng. Trong phút giây ấy, dường như họ nghe thấy tiếng của đất, của nước, của những người thân yêu từ nơi chôn nhau cắt rốn vọng về.', 'Thanh Tịnh');
...
- Đất nước Ê-ti-ô-pi-a là cha, là mẹ, là anh em ruột thịt của chúng tôi. Chúng tôi đã tiếp các ông như những người khách quý. Nhà vua đã tặng các ông nhiều sản vật hiếm. Nhưng đất Ê-ti-ô-pi-a là thiêng liêng, cao quý nhất. Chúng tôi không thể để các ông mang đi, dù chỉ là một hạt cát nhỏ.', 'Truyện cổ Ê-ti-ô-pi-a');
...
Ông Cản Ngũ vẫn đứng nghiêng mình nhìn Quắm Đen mồ hôi mồ kê nhễ nhại dưới chân. Lúc lâu, ông mới thò tay xuống nắm lấy khố Quắm Đen, nhấc bổng anh ta lên, nhẹ nhàng như giơ con ếch có buộc sợi rơm ngang bụng vậy.', 'Kim Lân');
...
Từ đấy, bác không bao giờ đi săn nữa.', 'Lép Tôn-xtôi');
...
Cậu bé hiểu ra, quay về nhà học bài.', 'Ngụ ngôn');
...
Là ngày qua vẫn còn.', 'Bế Kiến Quốc');
...
Phần thưởng của Na là một chiếc cặp sách màu hồng rất đẹp.', 'Sưu tầm');
...
Bé luôn luôn bận rộn, mà lúc nào công việc cũng đầy vui vẻ.', 'Tô Hoài');
...
Cả lớp cười rộ lên thích thú. Buổi học hôm ấy thật vui.', 'Sưu tầm');
...
Bố gật đầu: "Sáng kiến của con hay lắm!".', 'Sưu tầm');
...
Cô tiên lại hiện ra. Hai anh em òa khóc, xin cô hóa phép cho bà sống lại, dù có phải sống nghèo khổ như xưa. Cô tiên phất chiếc quạt thần. Lâu đài, ruộng vườn biến mất. Bà hiện ra, móm mém cười, hai tay ôm hai đứa cháu hiếu thảo vào lòng.', 'Truyện cổ tích');
...
Tuấn lúng túng xin lỗi Hà. Vui vẻ trở lại, Hà tung tăng chạy đi.', 'Sưu tầm');
...
Và mang một mẩu bánh mì con con.', 'Phan Thị Vàng Anh');
...
Bình yêu lắm đôi bàn tay rám nắng, các ngón tay gầy gầy, xương xương của mẹ.', 'Tạ Hữu Yên');
...
Nhưng em vẫn thấy bố ở rất gần. Vì bố luôn ở trong tim em.', 'Phạm Đình Ân');
...
Nhưng mà thật vui
Ai yêu em bé
Thì làm được thôi.', 'Phan Thị Thanh Nhàn');
...
Vào mùa lan, sáng nào bà cũng cài một búp lan lên mái tóc em.', 'Sưu tầm');
...
Mèo rất tức giận nhưng đã muộn mất rồi.', 'Sưu tầm');
...
- Cháu mời bác uống nước ạ!', 'Trần Đăng Khoa');
...
Bác Tâm đi thuyền thúng vào giữa đầm hái hoa, hái gương sen về.', 'Tập đọc lớp 1');
...
Thu đến, từng chùm quả chín vàng. Trong quả có nhân hạt ăn bùi bùi.', 'Đoàn Giỏi');
