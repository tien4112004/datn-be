...
(1, 'TV', 'HOA MAI VÀNG', 'Nhà bác Khải thật lắm hoa, có vài trăm thứ, rải rác khắp cả khu đất. Các cánh hoa dài ngắn, đủ sắc xanh, đỏ, trắng, vàng, đủ hình đủ dạng.

Mai thích hoa đại, hoa nhài, hoa mai, nhất là hoa mai vàng.', NULL, false, NULL);

-- Insert: TRÍ KHÔN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'TRÍ KHÔN', 'Một hôm, nom thấy bác thợ cày bảo gì trâu phải nghe nấy, Cọp lấy làm lạ hỏi:
...
- Trí khôn của ta đây! Trí khôn của ta đây!', NULL, false, NULL);

-- Insert: CON QUẠ THÔNG MINH
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CON QUẠ THÔNG MINH', 'Có một con quạ khát nước. Nó tìm thấy một cái lọ nước. Nhưng nước trong lọ quá ít, cổ lọ lại cao, nó không sao thò mỏ vào uống được. Nó nghĩ ra một cách: nó lấy mỏ gắp từng viên sỏi bỏ vào lọ. Một lúc sau, nước dâng lên, quạ tha hồ uống.', NULL, false, NULL);

-- Insert: NHỚ BÀ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'NHỚ BÀ', 'Bà vẫn ở quê. Bé rất nhớ bà.

Bà đã già, mắt đã loà, thế mà bà đan lát, cạp rổ, cạp rá bà tự làm cả. Bà vẫn rất ham làm.', NULL, false, NULL);

-- Insert: HOA CÚC VÀNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'HOA CÚC VÀNG', 'Suốt cả mùa đông
Nắng đi đâu miết
Trời đắp chăn bông
Còn cây chịu rét
...
Đầy sân cúc vàng
Thấy mùa xuân đẹp
Nắng lại về chăng?', NULL, false, NULL);

-- Insert: CẦU VỒNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CẦU VỒNG', 'Sau cơn mưa, ta thường thấy hình vòng cung rực rỡ trên bầu trời. Vòng cung đó được gọi là cầu vồng.
...
(theo khoaoc.com)', 'khoaoc.com', false, NULL);

-- Insert: HOA GIẤY
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'HOA GIẤY', 'Trước nhà, mấy cây bông giấy nở hoa tưng bừng. Trời càng nắng gắt, hoa giấy càng bồng lên rực rỡ. Màu đỏ thắm, màu tím nhạt, màu da cam, màu trắng muốt tinh khiết. Cả vòm cây lá chen hoa bao trùm lấy ngôi nhà lẫn mảnh sân nhỏ phía trước.

Hoa giấy đẹp một cách giản dị. Mỗi cánh hoa giống hệt một chiếc lá, chỉ có điều mỏng manh hơn và có màu sắc rực rỡ.

(theo Trần Hoài Dương)', 'Trần Hoài Dương', false, NULL);

-- Insert: TẤM CÁM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'TẤM CÁM', 'Tấm và Cám là hai chị em cùng cha khác mẹ! Ngày kia, dì ghẻ bảo hai chị em ra đồng xúc tép. Tấm siêng năng bắt được giỏ đầy. Cám ham chơi chẳng bắt được gì.', NULL, false, NULL);

-- Insert: VIỆC LÀM Ý NGHĨA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'VIỆC LÀM Ý NGHĨA', 'Chú Long mới chuyển đến khu phố nhà Huy. Chú thường thu gom chai lọ về rửa sạch, xếp gọn lại. Thấy vậy, Huy thắc mắc:
...
(Mộc Miên)', 'Mộc Miên', false, NULL);

-- Insert: HOA NGỌC LAN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'HOA NGỌC LAN', 'Đầu hè nhà bà em có một cây hoa ngọc lan.
...
Sáng sáng, bà vẫn cài hoa lan cho bé. Bé thích lắm.', NULL, false, NULL);

-- Insert: BÀ TRIỆU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'BÀ TRIỆU', 'Sau Hai Bà Trưng hai trăm năm, Bà Triệu lại cùng nhân dân khởi nghĩa chống giặc Ngô đô hộ nước ta. Bà thường mặc áo giáp, cưỡi voi xông pha trận mạc.

Nay ở Thanh Hóa vẫn còn đền thờ Bà Triệu và lưu truyền những câu ca về bà.', NULL, false, NULL);

-- Insert: BIỂN NHA TRANG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'BIỂN NHA TRANG', 'Biển Nha Trang quanh năm xanh màu xanh đặc biệt. Ngoài biển xa là đảo Tre, đảo Yến. Sát liền mặt biển là bãi cát trắng tinh, kề đó có hàng phi lao yên ả.

Hằng năm, khách du lịch từ các miền đổ về bãi biển Nha Trang tham quan và nghỉ mát.', NULL, false, NULL);

-- Insert: HỌC LÀM TỔ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'HỌC LÀM TỔ', 'Chích chòe, tu hú và sẻ con đến lớp cô chim khách để học cách làm tổ. Khi cô dạy, chích chòe chăm chú lắng nghe và ghi nhớ từng lời. Sẻ con và tu hú thì ham chơi.Cuối buổi học, cô dặn trò về tập làm tổ. Sau mười ngày, cô kiểm tra.

Ngày cô đến, tu hú và sẻ con đều ấp úng: Thưa cô…..làm tổ khó quá ạ! Đến tổ chích chòe, cô khen: Tổ của con vừa chắc vừa đẹp. Cô tặng chích chòe quyển sách có nhiều tranh ảnh. Tu hú và sẻ con đều ân hận. Chúng hứa với cô sẻ chăm học để làm được tổ.', NULL, false, NULL);

-- Insert: CON BÚP BÊ BẰNG VẢI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CON BÚP BÊ BẰNG VẢI', 'Ngày sinh nhật Thủy, mẹ đưa Thủy ra phố bán đồ chơi. Mẹ bảo Thủy chọn một thứ đồ chơi em thích nhất. Đi dọc gần hết phố bán đồ chơi, Thuỷ vẫn không biết nên mua gì. Đến cuối phố, thấy một bà cụ tóc bạc ngồi bán những con búp bê bằng vải giữa trời giá lạnh, Thủy kéo tay mẹ dừng lại. Thủy nhìn bà, rồi chỉ vào con búp bê được khâu bằng mụn vải xanh và nói:
...
- Vì con thương bà. Trời lạnh thế mà bà không được ở nhà. Con mua búp bê cho bà vui.', NULL, false, NULL);

-- Insert: ĐI HỌC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'ĐI HỌC', 'Thỏ ngọc gặp sóc đi học. Sóc ôm một quả bóng to. Sóc rủ thỏ ngọc nghỉ chân để đábóng. Thỏ ngọc đáp: “ Đang đi học, chớ đá bóng. Bố mẹ sẽ không yên tâm khi tớ tự đi học”.

Nghe xong, sóc chợt nhớ cô sơn ca luôn dặn: “Chỉ nên đá bóng ở trên sân”.', NULL, false, NULL);

-- Insert: MẦM SỐNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'MẦM SỐNG', 'Một hạt giống nhỏ rớt xuống và bị chôn trong lớp đất mềm. Khi cơn mưa trút xuống, nước thấm vô lòng đất. Hạt giống uống dòng nước mát. Rễ sớm mọc ra, tựa như những ngón chân bám chặt trong lòng đất. Mầm non vượt lên trên mặt đất. Thân và lá nhú ra, nghển lên như thể để nghe tiếng thở của không gian.', NULL, false, NULL);

-- Insert: CHÚ SÓC NGOAN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CHÚ SÓC NGOAN', 'Trong khu rừng nọ có gia đình sóc. Cả nhà sóc đều có bộ lông nâu, óng mượt, đẹp ơi là đẹp! Còn sóc con thì vô cùng xinh xắn, đáng yêu.
...
- Sóc con ngoan quá! Nào cả nhà mình cùng ăn nhé!', NULL, false, NULL);

-- Insert: BẠN CỦA NAI NHỎ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'BẠN CỦA NAI NHỎ', 'Nai Nhỏ xin cha cho đi chơi xa cùng bạn.

Biết bạn của con khỏe mạnh, thông minh và nhanh nhẹn, cha Nai Nhỏ vẫn lo. Khi biết bạn của con dám liều mình cứu người khác, cha Nai Nhỏ mới yên lòng cho con đi chơi với bạn.', NULL, false, NULL);

-- Insert: CHÕNG TRE CỦA BÀ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CHÕNG TRE CỦA BÀ', 'Tôi thích nhất là được cùng bà nằm trên chõng tre vào mỗi đêm hè. Bà đặt chiếc chõng tre ngoài hiên. Tôi ôm chiếc gối nhỏ ra nằm cạnh bà. Màn đêm thật yên tĩnh. Tôi nghe rõ từng nhịp thở của bà. Bà kể chuyện cổ tích cho tôi nghe. Giọng bà thủ thỉ, lúc trầm lúc bổng và thoảng vị trầu cay. Cùng tiếng kẽo kẹt của chõng tre, là tiếng vỗ nhẹ nhàng của bà ru cho tôi ngủ. Tiếng vỗ nhẹ nhàng ấy mới thân thương làm sao.', 'Hồ Huy Sơn', false, NULL);

-- Insert: CÔ GIÁO TÍ HON
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CÔ GIÁO TÍ HON', 'Bé kẹp lại tóc, thả ống quần xuống, lấy cái nón của má đội lên đầu. Nó cố bắt chước dáng đi khoan thai của cô giáo, khi cô bước vào lớp. Mấy đứa nhỏ làm y hệt đám học trò, đứng cả dậy, khúc khích cười chào cô.

Bé treo nón, mặt tỉnh khô, bẻ một nhánh trâm bầu làm thước. Mấy đứa em chống hai tay ngồi nhìn chị. Làm như cô giáo, Bé đưa mắt nhìn đám học trò, tay cầm nhánh trâm bầu nhịp nhịp lên tấm bảng.', 'Nguyễn Thi', false, NULL);

-- Insert: BIỂN ĐẸP
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'BIỂN ĐẸP', 'Biển luôn thay đổi màu tùy theo sắc mây trời. Trời xanh thẳm, biển cũng thẳm xanh, như dâng cao lên, chắc nịch. Trời rải mây trắng nhạt, biển mơ màng dịu hơi sương. Trời âm u mây mưa, biển xám xịt, nặng nề. Trời ầm ầm dông gió, biển đục ngầu, giận giữ.

Như một con người biết buồn vui, biển lúc tẻ nhạt, lạnh lùng, lúc sôi nổi, hả hê, lúc đăm chiêu, gắt gỏng.', 'Vũ Tú Nam', false, NULL);

-- Insert: GẤU CON NGOAN NGOÃN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'GẤU CON NGOAN NGOÃN', 'Bác Voi tặng Gấu con một rổ lê. Gấu con cảm ơn bác Voi rồi chọn quả lê to nhất biếu ông nội, quả lê to thứ nhì biếu bố mẹ.

Gấu con chọn quả lê to thứ ba cho Gấu em. Gấu em thích quá , ôm lấy quả lê. Hai anh em cùng nhau vui vẻ cười vang khắp nhà.', 'Báo Giáo dục Thành phố Hồ Chí Minh', false, NULL);

-- Insert: NHỮNG TRÒ CHƠI CÙNG ÔNG BÀ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'NHỮNG TRÒ CHƠI CÙNG ÔNG BÀ', 'Khi còn nhỏ, bé thường chơi trốn tìm với ông bà. Lớn lên một chút, bé đã biết cùng ông bà đóng kịch, múa hát. Bé còn chơi làm bếp với ông bà. Vào lớp Một, bé biết đọc, biết viết. Bé có thể cùng ông bà đọc truyện. Bé cũng có thể cùng ông bà chơi cờ vua, thi vẽ tranh.

Được vui chơi cùng ông bà sẽ giúp bé thêm lớn khôn.', 'Shi-mu-ra Yo-ko', false, NULL);

-- Insert: BUỔI SỚM MÙA HÈ TRONG THUNG LŨNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
...
Trên mấy cây cao cạnh nhà, ve đua nhau kêu ra rả. Ngoài suối, tiếng chim cuốc vọng vào đều đều. Bản làng đã thức giấc. Đó đây, ánh lửa hồng bập bùng trên các bếp. Ngoài bờ ruộng đã có bước chân người đi, tiếng nói chuyện rì rầm, tiếng gọi nhau í ới.', 'Hoàng Hữu Bội', false, NULL);

-- Insert: CHUYỂN NHÀ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CHUYỂN NHÀ', 'Hôm nay, gia đình thỏ dọn đến nhà mới. Bố mẹ Thỏ đã chuyển được nhiều đồ đạc, chỉ còn lại một cái bàn, hai cái ghế và cái giỏ khâu của mẹ. Năm anh em thỏ bàn nhau chuyển nốt đồ đạc đến nhà mới giúp bố mę.
...
Mẹ khen năm anh em rất ngoan, biết giúp đỡ bố mẹ.', NULL, false, NULL);

-- Insert: TÌNH THƯƠNG CỦA BÁC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'TÌNH THƯƠNG CỦA BÁC', 'Đêm giao thừa năm ấy, Bác Hồ đến thăm một gia đình lao động nghèo ở Hà Nội. Anh cán bộ đến trước nói với chị Chín:
...
- Có bao giờ...có bao giờ Chủ tịch nước lại tới thăm nhà chúng con. Được thấy Bác đến nhà, con cảm động quá!', 'Phạm Thị Sửu – Lê Minh Hà', false, NULL);

-- Insert: HOA CÀ PHÊ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'HOA CÀ PHÊ', 'Hoa cà phê có mùi thơm đậm đà và ngọt ngào nên nó thường theo gió bay đi rất xa. Ong bướm từ khắp nơi cứ theo mùi thơm đó mà tìm về hút nhụy, nhả mật nên mùa hoa cà phê cũng còn là vụ thu hoạch mật ong ở Đắk Lắk. Cứ đến tầm tháng 11, khi những cánh hoa cà phê bung ra một màu trắng xóa là từng đàn ong bướm từ các nơi đổ về vờn bay, tạo nên một bức tranh đẹp và sinh động. Nếu từ trên cao nhìn xuống, bạn sẽ thấy Đắk Lắk được phủ một màu trắng tinh khôi đang dập dờn như những con sóng nhấp nhô. Đắk Lắk đẹp là nhờ được khoác lên mình một màu trắng trinh nguyên đó.

Cây cà phê làm giàu cho Đắk Lắk. Hoa cà phê làm đẹp cho Đắk Lắk. Hương cà phê làm cho Đắk Lắk trở nên quyến rũ và đáng yêu hơn.', 'Thu Hà', false, NULL);

-- Insert: CẢNH VỀ ĐÊM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CẢNH VỀ ĐÊM', 'Cuối ngày, những tia nắng cuối cùng cũng dần biến mất, màn đêm bắt đầu buông xuống bao trùm cả thành phố. Những ngọn đèn được bật lên, toả sáng tựa như những vì sao trên bầu trời. Trên bầu trời, trăng trôi lơ lửng, hững hờ, trăng tròn và sáng tỏ hơn. Dưới lòng thủ đô, ngoài vẻ đẹp cổ kính của đền Ngọc Sơn, cầu Thê Húc... ai cũng choáng ngợp bởi nét đẹp của đô thị sầm uất. Những toà nhà cao tầng đồ sộ, cao vút trời mọc lên sát nhau. Ánh đèn đường, đèn điện trong nhà được thắp lên tạo thành những tia sáng lung linh, xua tan màn đêm tối tăm. Hàng cây xanh ven đường cũng được thay màu áo mới. Những dây đèn đủ màu liên tục chớp nháy trông thật đã mắt.', NULL, false, NULL);

-- Insert: CÁ HEO Ở VÙNG BIỂN TRƯỜNG SA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CÁ HEO Ở VÙNG BIỂN TRƯỜNG SA', 'Đêm trăng, biển yên tĩnh. Một số chiến sĩ thả câu. Một số khác quây quẩn trên boong tàu ca hát, thổi sáo. Bỗng có tiếng đập nước ùm ùm như có ai đang tập bơi. Một người kêu lên: “Cá heo!”. Mọi người ùa ra vỗ tay hoan hô: “A! Cá heo nhảy múa đẹp quá!”. Nghe thế, cá heo thích lắm, nhảy vút lên thật cao.

Có chú nhảy quá đà, vọt lên cả lên boong tàu. Anh chiến sĩ vội chạy lại, vuốt ve chỗ đau rồi thả chú cá xuống nước. Cả đàn cá heo quay qua quay lại cạnh con tàu, nhảy lên một lần cuối như để cảm ơn rồi lặn xuống dưới biển.', NULL, false, NULL);

-- Grade 2

-- Insert: NHỮNG CON SAO BIỂN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'NHỮNG CON SAO BIỂN', 'Một người đàn ông đang dạo bộ trên bãi biển khi chiều xuống. Biển đông người, nhưng ông lại chú ý đến một cậu bé cứ liên tục cúi xuống nhặt thứ gì đó lên rồi thả xuống biển.
...
Người đàn ông trìu mến nhìn cậu bé và cùng cậu cứu những con sao biển.', 'Hạt giống tâm hồn – Phép màu có giá bao nhiêu?', false, NULL);

-- Insert: CHIẾC BA LÔ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CHIẾC BA LÔ', 'Trong những ngày sống ở Việt Bắc, một lần đi công tác, Bác đi với hai đồng chí. Mỗi người mang một chiếc ba lô. Qua một chặng, mọi người dừng chân, Bác đến chỗ đồng chí bên cạnh, xách chiếc ba lô lên.
...
Hai đồng chí kia lại phải san đều các thứ vào ba chiếc ba lô.', '117 CHUYỆN KỂ VỀ TẤM GƯƠNG ĐẠO ĐỨC HỒ CHÍ MINH', false, NULL);

-- Insert: CÂY XANH VÀ CON NGƯỜI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CÂY XANH VÀ CON NGƯỜI', '1. Con người không thể sống thiếu cây xanh. Lúa, ngô, khoai, sắn,…nuôi sống ta. Các loại rau là thức ăn hằng ngày của ta. Chuối, cam, bưởi, khế,… cho ta trái ngọt.
...
Làm cho đất nước càng ngày càng xuân”', 'Trung Đức', false, NULL);

-- Insert: RƯỚC ĐÈN ÔNG SAO
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'RƯỚC ĐÈN ÔNG SAO', 'Tết Trung thu đã đến. Mẹ Tâm rất bận nhưng vẫn sắm cho Tâm một mâm cỗ nhỏ: Một quả bưởi có khía thành tám cánh hoa, mỗi cánh hoa bưởi cài một quả ổi chín, để bên cạnh một nải chuối ngự và bó mía tím. Tâm rất thích mâm cỗ. Em đem mấy thứ đồ chơi bày xung quanh, nom rất vui mắt.

Chiều rồi đêm xuống, trẻ con bên hàng xóm bập bùng trống ếch rước đèn. Lúc đó, Tâm lại thấy không thích mâm cỗ của mình bằng đám rước đèn. Tâm bỏ mâm cỗ chạy đi xem.', 'Nguyễn Thị Ngọc Tú', false, NULL);

-- Insert: ĂNG-CO VÁT
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'ĂNG-CO VÁT', 'Ăng-co Vát là một công trình kiến trúc và điêu khắc tuyệt diệu của nhân dân Cam-pu-chia được xây dựng từ đầu thế kỉ 12.

Toàn bộ khu đền quay về hướng tây. Lúc hoàng hôn, Ăng-co Vát thật huy hoàng. Mặt trời lặn, ánh sáng chiếu soi vào bóng tối cửa đền. Những ngọn tháp cao vút ở phía trên, lấp loáng giữa những chùm lá thốt nốt xòa tán tròn vượt lên hẳn những hàng muỗm già cổ kính. Ngôi đền cao với những thềm đá rêu phong, uy nghi kì lạ, càng cao càng thâm nghiêm dưới ánh trời vàng, khi đàn dơi bay tỏa ra từ các ngách.', 'Những kì quan thế giới', false, NULL);

-- Insert: CÂY ĐA QUÊ HƯƠNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
...
Chiều chiều, chúng tôi ra ngồi gốc đa hóng mát. Lúa vàng gợn sóng. Xa xa, giữa cánh đồng, đàn trâu ra về, lững thững từng bước nặng nề. Bóng sừng trâu dưới ánh chiều kéo dài, lan giữa ruộng đồng yên lặng.', 'NGUYỄN KHẮC VIỆN', false, NULL);

-- Insert: CHIM CHIỀN CHIỆN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CHIM CHIỀN CHIỆN', 'Chiền chiện có nhiều nơi còn gọi là sơn ca. Chiền chiện giống sẻ đồng nhưng áo không một màu nâu sồng như chim sẻ. Áo của chiền chiện màu đồng thau, đốm đậm đốm nhạt rất hài hòa. Chiền chiện chân cao và mảnh, đầu rất đẹp, dáng thấp như một kị sĩ.

Chiền chiện có mặt ở khắp nơi, nhất là những vùng trời đất bao la. Khi chiều thu buông xuống, lúc đã kiếm ăn no nê trên bãi đồng, chiền chiện vụt bay lên như viên đá ném vút lên trời. Theo cùng tiếng chim bay lên, từ không trung vọng xuống tiếng hót trong sáng diệu kì, giọng ríu ran đồ hồi, âm điệu hài hòa, quyến rũ…Tiếng chim là tiếng nói của sứ giả mặt đất gửi tặng trời. Rồi, tiếng chim lại là tiếng nói của thiên sứ gửi lời chào mặt đất.', 'Ngô Văn Phú', false, NULL);

-- Insert: MÓN QUÀ QUÊ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'MÓN QUÀ QUÊ', 'Từ ngoài quê vào, ông Tư biếu gia đình Tuấn một bịch muối hạt làm quà. Thấy bịch muối, Tuấn buột miệng:

Sao muối không trắng, mịn như muối nhà mình? Ba cười và bảo Tuấn:

Muối biển ở quê quý lắm con à.

Thấy Tuấn, ông Tư cười móm mém:

Ông có bánh tổ cho cháu đây! Ông đưa cho Tuấn một cái bánh bọc trong khuôn lá chuối. Bánh tròn, to, màu nâu sẫm, có rắc mè, trông bình thường và không hấp dẫn. Tuấn ấp úng:

Cháu cảm ơn ông Tư. Nhưng cháu...

Mẹ chạm nhẹ vào tay Tuấn:

Con cảm ơn cậu Tư. Cậu vẫn nhớ món bánh tụi con mê từ hồi nhỏ...

Ông Tư về rồi, mẹ nhẹ nhàng nói với Tuấn:

Đây là bánh quê mình. Phải quý nhà mình lắm ông Tư mới đem từ quê vào cho. Ngon lắm, con ăn thử xem.

Cắn một miếng bánh, Tuấn bất ngờ bởi vị ngọt và hương thơm rất lạ. Tuấn sẽ gọi điện xin lỗi ông Tư, mong hè sẽ về thăm ông Tư và được ông cho ăn bánh tổ.', 'Kim Hài', false, NULL);

-- Insert: MÙA THU SANG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'MÙA THU SANG', 'Cứ mỗi độ thu sang
...
Đẹp thay lúc thu sang!', 'Trần Lê Văn', false, NULL);

-- Insert: RỪNG MƠ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'RỪNG MƠ', 'Giữa mùa hoa mơ nở
...
Kết đọng một mùa xuân', 'Trần Lê Văn', false, NULL);

-- Insert: CÁNH DIỀU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CÁNH DIỀU', 'Cánh diều của trẻ con chúng tôi mềm mại như cánh bướm, thanh sạch vì không hề vụ lợi. Trong khi người lớn chạy bật móng chân để rong diều thì đám mục đồng chúng tôi sướng đến phát dại nhìn lên trời. Sáo lông ngỗng vi vu trầm bổng. Sáo đơn rồi sáo kép, sáo bè … như gọi thấp xuống vì những sao sớm.

Ban đêm trên bãi thả diều thật không còn gì huyền ảo hơn. Có cảm giác diều đang trôi,… người lớn về dần, bỏ mặt chúng tôi với bầu trời, một tấm thảm nhung khổng lồ. Chúng tôi chỉ còn trăng, sao và những cánh diều.', 'TẠ DUY ANH', false, NULL);

-- Insert: KHI TRANG SÁCH MỞ RA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
...
Một chân trời đang đi.', NULL, false, NULL);

-- Insert: NHÀ BÁC HỌC VÀ BÀ CON NÔNG DÂN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'NHÀ BÁC HỌC VÀ BÀ CON NÔNG DÂN', 'Hôm ấy, tiến sĩ nông học Lương Định Của cùng cán bộ xuống xem xét tình hình nông nghiệp ở tỉnh Hưng Yên.
...
Thế là cuộc thi bắt đầu. Chỉ ít phút sau, bác đã bỏ xa cô gái cấy giỏi nhất vài mét. Lúa bác cấy vừa đều vừa thẳng hàng. Thấy vậy, ai nấy đều trầm trồ, thán phục nhà bác học nói và làm đều giỏi.', 'Nguyễn Hoài Giang', false, NULL);

-- Insert: SƠN TINH, THỦY TINH
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'SƠN TINH, THỦY TINH', '1. Hùng Vương thứ mười tám có một người con gái đẹp tuyệt trần, tên là Mị Nương. Nhà vua muốn kén cho công chúa một người chồng tài giỏi.
...
Từ đó, năm nào Thủy Tinh cũng dâng nước đánh Sơn Tinh, gây lũ lụt khắp nơi nhưng lần nào Thủy Tinh cũng chịu thua.', 'TRUYỆN CỔ VIỆT NAM', false, NULL);

-- Insert: MÙA VÀNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'MÙA VÀNG', 'Thu về, những quả hồng đỏ mọng, những hạt dẻ nâu bóng, những quả na mở to mắt, thơm dìu dịu. Biển lúa vàng ươm. Gió nổi lên và sóng lúa vùng dập dồn trải tới chân trời.
...
- Mẹ ơi, con hiểu rồi. Công việc của các bác nông dân vất vả quá mẹ nhỉ?', 'Những câu chuyện hay, những bài học quỹ', false, NULL);

-- Insert: CHUYỆN QUẢ BẦU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CHUYỆN QUẢ BẦU', 'Ngày xưa có vợ chồng nọ đi rừng, bắt được một con dúi. Dúi xin tha, họ thương tình tha cho nó.
...
Đó là tổ tiên của các dân tộc anh em trên đất nước ta ngày nay.', 'Truyện cổ Khơ Mú', false, NULL);

-- Insert: MÙA NƯỚC NỔI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'MÙA NƯỚC NỔI', 'Mùa này, người làng tôi gọi là mùa nước nổi, không gọi là mùa nước lũ vì nước lên hiền hòa, chứ không dữ dội như những nơi khác. Nước mỗi ngày một dâng lên, cuồn cuộn đầy bờ. Mưa dầm dề, mưa sướt mướt ngày này qua ngày khác.

Rồi đến Rằm tháng Bảy. Dòng sông Cửu Long đã no đầy, lại tràn qua bờ, tràn qua cả mặt đường. Nước trong ao hồ, trong đồng ruộng của mùa mưa hòa lẫn với nước dòng sông Cửu Long.', 'Nguyễn Quang Sáng', false, NULL);

-- Insert: TỔ QUỐC EM ĐẸP LẮM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'TỔ QUỐC EM ĐẸP LẮM', 'Cong cong hình lưỡi liềm
...
Rừng vàng: đầy quặng, gỗ.', 'Phạm Hổ', false, NULL);

-- Insert: BÀI HỌC VỀ CHỮ TÍN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'BÀI HỌC VỀ CHỮ TÍN', 'Hồi ở Pác Bó, Bác Hồ sống rất chan hòa với mọi người. Một hôm được tin Bác đi công tác xa, một trong những em bé thường ngày quấn quýt bên Bác chạy đến cầm tay Bác thưa:
...
Cây gạo già mỗi năm lại trở lại tuổi xuân, càng nặng trĩu những chùm hoa đỏ mọng và đầy tiếng chim hót.', 'Vũ Tú Nam', false, NULL);

-- Insert: SỰ TÍCH HOA TỈ MUỘI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'SỰ TÍCH HOA TỈ MUỘI', 'Ngày xưa, có hai chị em Nết và Na mồ côi cha mẹ, sống trong ngôi nhà nhỏ bên sườn núi. Nết thương Na, cái gì cũng nhường em. Đêm đông. Gió ù ù lùa vào nhà, Nết vòng tay ôm em:
...
Hoa kết thành chùm, bông hoa lớn che chở cho nụ hoa bé nhỏ. Chúng cũng đẹp như tình chị em của Nết và Na. Dân làng đặt tên cho loài hoa ấy là hoa tỉ muội.', 'Trần Mạnh Hùng', false, NULL);

-- Insert: CÁ DIẾC CON
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CÁ DIẾC CON', 'Chú Diếc con mới lớn đang tung tăng bơi lội, nô đùa trong hồ nước. Nhìn cái gì, Diếc con cũng thấy lạ. Bỗng có bác Rùa từ đâu bơi tới. Diếc con tròn mắt nhìn. Lạ quá, cùng ở dưới nước mà bác ấy không giống họ hàng nhà cá: cái đầu thò ra, thụt vào. Cái đuôi ngắn ngủn ngủn. Cái "nhà" trên lưng thật nặng nề. Lại còn bốn cái chân thô kệch nữa chứ!

Diếc con chê bác Rùa xấu xí. Diếc mẹ biết vậy liền kể:

Bác Rùa cao tuổi nhất, hiểu biết nhất vùng hồ này. Nhờ có bốn chân, bác Rùa lên được bờ, biết nhiều cảnh, nhiều chuyện trên cạn. Bác rất tốt bụng, hay giúp đỡ người khác.', NULL, false, NULL);

-- Insert: MÙA HOA SẤU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'MÙA HOA SẤU', 'Vào những ngày cuối xuân, đầu hạ, khi nhiều loài cây đã khoác màu áo mới thì cây sấu mới bắt đầu chuyển mình thay lá. Đi dưới rặng sấu, ta sẽ gặp những chiếc lá nghịch ngợm. Nó quay tròn trước mặt, đậu lên đầu, lên vai ta rồi mới bay đi. Nhưng ít ai nắm được một chiếc lá đang rơi như vậy.

Từ những cành sấu non bật ra những chùm hoa trắng muốt, nhỏ như những chiếc chuông tí hon. Hoa sấu thơm nhẹ. Vị hoa chua chua thấm vào đầu lưỡi, tưởng như vị nắng non của mùa hè mới đến vừa đọng lại.', 'Băng Sơn', false, NULL);

-- Grade 3

-- Insert: NGƯỜI MẸ HIỀN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'NGƯỜI MẸ HIỀN', 'Giờ ra chơi, Minh thì thầm với Nam: "Ngoài phố có gánh xiếc, bọn mình ra xem đi!". Nghe vậy, Nam không nén nổi tò mò. Nhưng cổng trường khóa, trốn ra sao được. Minh bảo:
...
Cô hài lòng, bảo hai em về chỗ rồi tiếp tục giảng bài.', 'Nguyễn Văn Thịnh', false, NULL);

-- Insert: TÌNH BẠN (CÚN CON DŨNG CẢM)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'TÌNH BẠN', 'Tối hôm ấy, mẹ đi vắng, dặn Cún trông nhà không được đi đâu. Chợt Cún nghe có tiếng kêu ngoài sân:
...
Làm đồ chơi khéo tay.', 'Phạm Anh Xuân', false, NULL);

-- Insert: HŨ BẠC CỦA NGƯỜI CHA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'HŨ BẠC CỦA NGƯỜI CHA', 'Ngày xưa, có một nông dân người Chăm rất siêng năng. Về già, ông để dành được một hũ bạc. Tuy vậy, ông rất buồn vì người con trai lười biếng. Một hôm, ông bảo con:
...
Về đến nhà, hai anh em thú nhận mọi chuyện với mẹ. Sẻ mẹ nhẹ nhàng bảo: “Không sao, hai con biết nhận lỗi là tốt. Nhưng giá như hai con nhớ lời mẹ dặn thì tối nay nhà mình đã có ngô để ăn rồi.”.', NULL, false, NULL);

-- Insert: SỰ TÍCH HOA CÚC TRẮNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'SỰ TÍCH HOA CÚC TRẮNG', 'Ngày xưa có một cô bé sống cùng mẹ trong một túp lều tranh dột nát nhưng đó là một bé gái vô cùng hiếu thảo. Thật không may mẹ của cô bé lại bị bệnh rất nặng nhưng vì nhà nghèo nên ko có tiền mua thuốc chữa, và cô bé vô cùng buồn bã.
...
Không đành lòng cô liền dùng tay xé nhẹ dần từng cánh hoa lớn thành những cánh hoa nhỏ và bông hoa cũng theo đó mà nhiều cánh dần lên nhiều đến mức không còn đếm được nữa. Từ đó người đời gọi bông hoa ấy là bông hoa cúc trắng để nói về lòng hiếu thảo của cô bé đó dành cho mẹ mình.', NULL, false, NULL);

-- Insert: CA HUẾ TRÊN SÔNG HƯƠNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'CA HUẾ TRÊN SÔNG HƯƠNG', 'Đêm. Thành phố lên đèn như sao sa. Màn sương dày dần lên, cảnh vật mờ đi trong một màu trắng đục. Tôi như một lữ khách thích giang hồ với hồn thơ lai láng, tình người nồng hậu bước xuống một con thuyền rồng, có lẽ con thuyền này kia chỉ dành cho vua chúa. Trước mũi thuyền là một không gian rộng thoáng để vua hóng mát ngắm trăng, giữa là một sàn gỗ bào nhẵn có mui vòm được trang trí lộng lẫy, xung quanh thuyền có hình rồng và trước mũi là một đầu rồng như muốn bay lên. Trong khoang thuyền, dàn nhạc gồm đàn tranh, đàn nguyệt, tì bà, nhị, đàn tam. Ngoài ra còn có đàn bầu, sáo và cặp sanh để gõ nhịp.
...
Trăng lên. Gió mơn man dìu dịu. Dòng sông trăng gợn sóng. Con thuyền bồng bềnh. Đêm nằm trên dòng Hương thơ mộng để nghe ca Huế, với tâm trạng chờ đợi rộn lòng.', 'Hà Ánh Minh', false, NULL);

-- Insert: NGƯỜI BẠN MỚI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'NGƯỜI BẠN MỚI', 'Cả lớp đang giải bài tập toán, bỗng một phụ nữ lạ bước vào, khẽ nói với thầy giáo:
...
– Khỉ con biết nghe lời mẹ, thật là đáng yêu!', 'Vân Nhi', false, NULL);

-- Insert: CHỒI BIẾC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'CHỒI BIẾC', 'Mùa xuân, những hạt mưa li ti giăng giăng thả bụi êm đềm, cây cối chịu qua giá rét của mùa đông ngủ một giấc đẫy chợt bừng tỉnh. Những hạt mưa đủ để cho cây cối nhú chồi biếc, hớn hở đón chào mùa xuân.

Chồi cây giống như cuộc đời của một con người. Khi mới nứt nanh, có một màu tím biếc thật dễ thương như cu con mới lọt lòng. Những lá non mới chui từ lòng mẹ chui ra, chúng còn yếu ớt, mềm mại non tơ, ngơ ngác với thiên nhiên. Hằng ngày được nắng, gió luyện rèn, chả mấy chốc chúng từ màu tím biếc đã chuyển sang màu xanh nõn. Lúc này, lá cây cũng giống như bàn tay em bé, vẫy vẫy theo gió xuân nhè nhẹ. Và tháng năm về, khi tiếng ve cưa miết vào không gian, cũng là lúc lá cây chuyển sang màu xanh đậm. Lúc này, lá cây ở thời kì sung sức nhất của cuộc đời mình. Từ những nách lá đã này ra những chùm hoa đỏ chói, vàng sáng, tím lịm như nhung ... rồi kết quả. Mùa thu đến, cũng là lúc lá cây về già, gân guốc nổi lên để chống chọi với những đợt gió táp, sương sa. Mùa đông, lá cây như những cụ già lụ khụ, úa vàng, máu còn úa đỏ trên mặt lá đã phải lìa cành để nhường lại cho cây ấp ủ những chồi biếc mai sau.', NULL, false, NULL);

-- Insert: SỰ TÍCH SÔNG HỒ Ở TÂY NGUYÊN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'SỰ TÍCH SÔNG HỒ Ở TÂY NGUYÊN', 'Ngày xưa, muông thú còn sống thành buôn làng, quanh một cái hồ lớn. Cuộc sống thật tươi vui, đầm ấm.
...
Ngày nay, khắp núi rừng Tây Nguyên đâu đâu cũng có sông hồ. Dân làng bảo: những dấu chân già làng Voi đánh nhau với Cá Sấu tạo thành hồ. Còn những dấu vết kéo gỗ ngang dọc hoá thành sông, suối.', 'Truyện cổ Tây Nguyên', false, NULL);
...
-- Insert: TÌNH BẠN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'TÌNH BẠN', 'Thỏ và Sóc rủ nhau vào rừng hái quả. Mùa thu, hương rừng thơm phức hương quả chín. Ở trên một cây cao chót vót, Thỏ reo lên sung sướng :
...
- Các cháu có một tình bạn thật đẹp.', NULL, false, NULL);

-- Insert: CHUYỆN VỀ HAI HẠT LÚA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CHUYỆN VỀ HAI HẠT LÚA', 'Có hai hạt lúa nọ được giữ lại để làm hạt giống cho vụ sau vì cả hai đều là những hạt lúa tốt, đều to khỏe và chắc mẩy.
...
Thanh kiếm và hoa hồng hiểu ra, chúng rối rít cảm ơn nhà thông thái. Cả hai bắt tay nhau thân thiện và không bao giờ cãi nhau nữa.', 'Truyện cổ tích Ả Rập', false, NULL);

-- Insert: TẤM LÒNG THẦM LẶNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'TẤM LÒNG THẦM LẶNG', 'Ngày nọ, bố tôi lái xe đưa ông chủ đi tham dự một buổi họp quan trọng tại một thành phố khác. Trong lúc nghỉ ở giữa đường, mấy cậu bé đang chơi quanh đấy hiếu kì kéo đến vây quanh, ngắm nghía và sờ mó chiếc xe sang trọng. Thấy một cậu bé trong nhóm đi cà nhắc vì bị tật ở chân, ông chủ liền bước ra khỏi xe, đến chỗ cậu bé và hỏi:
...
Về sau, cậu bé Giêm-mi may mắn ấy trở thành một nhà kinh doanh rất thành đạt như mơ ước của mình. Đến tận khi qua đời, theo tôi biết, Giêm-mi vẫn không biết ai là người giúp đỡ ông chữa bệnh hồi đó… Nhiều năm trôi qua, tôi luôn ghi nhớ lời ông chủ đã nói với bố tôi: “Cho đi mà không cần phải nhận lại sẽ là niềm vui lâu dài”.', 'Bích Thủy', false, NULL);

-- Insert: CÂY SỒI VÀ CÂY SẬY
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CÂY SỒI VÀ CÂY SẬY', 'Trong khu rừng nọ có một cây sồi cao lớn sừng sững đứng ngay bên bờ một dòng sông. Hằng ngày, nó khinh khỉnh nhìn đám sậy bé nhỏ, yếu ớt, thấp chùn dưới chân mình.
...
Nghe vậy, cây sồi ngậm ngùi, xấu hổ. Nó không còn dám coi thường cây sậy bé nhỏ yếu ớt nữa.', 'Truyện ngụ ngôn nước ngoài', false, NULL);

-- Insert: NGƯỜI ĂN XIN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'NGƯỜI ĂN XIN', 'Lúc ấy, tôi đang đi trên phố. Một người ăn xin già lọm khọm đứng ngay trước mặt tôi. Đôi mắt ông lão đỏ đọc và giàn giụa nước mắt. Đôi môi tái nhợt, áo quần tả tơi thảm hại... Chao ôi! Cảnh nghèo đói đã gặm nát con người đau khổ kia thành xấu xí biết nhường nào!
...
Khi ấy, tôi chợt hiểu rằng: cả tôi nữa, tôi cũng vừa nhận được chút gì của lão.', 'Tuốc-ghê-nhép', false, NULL);

-- Insert: CHUYỆN VỀ MỘT CÀNH NHO
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CHUYỆN VỀ MỘT CÀNH NHO', 'Một cành nho mảnh mai lớn lên nhờ những dòng nước khoáng tinh khiết từ lòng đất. Nó thật trẻ trung, khỏe mạnh và tràn đầy sức sống. Nó cảm thấy rất tự tin khi tất cả chỉ dựa vào chính bản thân nó.
...
Nó ngước nhìn các cành nho kia với vẻ e dè và hoài nghi. “Bạn đừng sợ, bạn chỉ cần quấn những sợi tua của bạn vào tôi là tôi có thể giúp bạn đứng thẳng dậy trong mưa bão.” Một cành nho nói nói. Và cây nho bé nhỏ đã làm theo.
...
Có những khó khăn chúng ta có thể vượt qua được bằng chính sức lực của mình. Nhưng có những thử thách lớn mà chúng ta chỉ có thể vượt qua nhờ tình yêu thương, đồng lòng gắn bó và chia sẻ với nhau như những cành nho nhỏ bé kia.”', 'Hạt giống tâm hồn', false, NULL);

-- Insert: MỘT VIỆC NHỎ THÔI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'MỘT VIỆC NHỎ THÔI', 'Một gia đình gồm hai vợ chồng và bốn đứa con nhỏ đi nghỉ mát ở một bãi biển vào dịp hè. Bọn trẻ rất thích tắm biển và xây những toà lâu đài trên cát. Bố mẹ chúng thuê một cái lều ngồi uống nước trên bờ, dõi nhìn các con vui đùa. Thế rồi, họ trông thấy một bà cụ nhỏ nhắn ăn mặc xuềnh xoàng, trên tay cầm một chiếc túi cũ đang tiến lại. Tóc bà đã bạc trắng, bị gió biển thổi tốc lên càng làm cho khuôn mặt nhăn nheo của bà thêm khó coi. Bà cụ lẩm bẩm, dáo dác nhìn rồi thỉnh thoảng lại cúi xuống nhặt những thứ gì đó trên bãi biển, bỏ vào cái túi.
...
Nghe xong câu chuyện, người chồng vội chạy ngay xuống bãi biển mong có thể nói một lời xin lỗi và một lời biết ơn chân thành, nhưng bà cụ đã đi xa rồi. Bóng bà chỉ còn là một chấm nhỏ trên bãi biển vắng người khi chiều đang xuống…', 'Internet Những câu chuyện cảm động – Diễn đàn làm cha mẹ', false, NULL);

-- Insert: ĐIỀU KÌ DIỆU CỦA MÙA ĐÔNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'ĐIỀU KÌ DIỆU CỦA MÙA ĐÔNG', 'Cây Bàng cuối phố xòe ra tán cây rộng như một cái ô xanh, đẹp như bàn tay trẻ con, vẫy đùa trong gió. Nó vừa nở những bông hoa trắng xanh, nhỏ li ti như ngàn ngôi sao lấp ló sau chùm lá. Lá Non hỏi cây mẹ:
...
- Mẹ ơi!… – Chiếc lá thầm thì điều gì đó với Cây Bàng.', 'Quỳnh Trâm', false, NULL);

-- Insert: SƯ TỬ VÀ KIẾN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'SƯ TỬ VÀ KIẾN', 'Sư Tử chỉ kết bạn với các loài vật nào to khoẻ như mình và cho rằng những con vật bé nhỏ chẳng có ích gì cho nó. Một lần, Kiến Càng đến xin kết bạn với Sư Tử, liền bị Sư Tử xua đuổi.
...
Sư Tử khỏi đau, hối hận vì đã đối xử không tốt với Kiến. Sư Tử vội vàng xin lỗi Kiến và từ đó coi Kiến là bạn thân nhất trên đời.', 'Truyện cổ dân tộc Lào', false, NULL);

-- Insert: CHIẾC LÁ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CHIẾC LÁ', 'Chim sâu hỏi chiếc lá:
...
– Tôi không bịa tí nào đâu! Mãi mãi tôi kính trọng những chiếc lá bình thường như thế. Chính nhờ họ mới có chúng tôi: những hoa, những quả, những niềm vui mà bạn vừa nói trên kia.', 'Trần Hoài Dương', false, NULL);

-- Insert: KỈ NIỆM MÙA HÈ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'KỈ NIỆM MÙA HÈ', 'Tôi là một cô bé say mê diều. Nhà tôi ở gần bãi đất rộng, dốc – chỗ bọn con trai trong xóm chọn làm nơi thả diều. Chiều chiều, khi đã nấu cơm xong, tôi có thể đứng lặng hàng giờ để ngắm những cánh diều đủ loại, đủ màu sắc bay trên bầu trời xanh lộng gió.
...
- Mình sẽ không bao giờ làm thế nữa.', 'NGUYỄN THỊ LIÊN', false, NULL);

-- Insert: BÓP NÁT QUẢ CAM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'BÓP NÁT QUẢ CAM', 'Giặc Nguyên cho sứ thần sang giả vờ mượn đường để xâm chiếm nước ta. Thấy sứ giặc ngang ngược, Trần Quốc Toản vô cùng căm giận.
...
Khi trở ra, Quốc Toản xoè tay cho mọi người xem cam quý. Nhưng quả cam đã nát từ bao giờ.', 'Nguyễn Huy Tưởng', false, NULL);

-- Insert: CHẬM VÀ NHANH
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CHẬM VÀ NHANH', 'Sang học kì mới, cô giáo góp ý với lớp nên lập ra những đôi bạn cùng tiến. Dũng nhìn Minh, nhìn lại bản nhận xét. Ở đó, thật ít lời khen.
...
“Chậm đâu phải lúc nào cũng không tốt. Nhai chậm để nghiền kĩ thức ăn, đi chậm để tránh những tai nạn đáng tiếc. Bạn chậm thì mình phải giúp bạn để bạn tiến bộ hơn chứ.” - Dũng thầm nghĩ.

Các bạn trong lớp đang nhao nhao chọn bạn cho mình. Dũng giơ tay:

- Em xin được học cùng với bạn Minh.
...
- Vì cậu đã chọn tớ. Tớ cứ nghĩ sẽ không ai chịu học với tớ.

Dũng cười:

- Tớ phải cảm ơn cậu mới đúng. Vì cậu đã cho tớ cơ hội được giúp đỡ người bạn tớ yêu quý.', 'Những hạt giống tâm hồn', false, NULL);

-- Insert: TRUNG THU ĐỘC LẬP
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'TRUNG THU ĐỘC LẬP', 'Đêm nay anh đứng gác ở trại. Trăng ngàn và gió núi bao la khiến lòng anh man mác nghĩ tới trung thu và nghĩ tới các em. Trăng đêm nay soi sáng xuống nước Việt Nam độc lập yêu quý của các em.Trăng sáng mùa thu vằng vặc chiếu khắp thành phố, làng mạc, núi rừng, nơi quê hương thân thiết của các em…

Anh nhìn trăng và nghĩ tới ngày mai…

Ngày mai, các em có quyền mơ tưởng một cuộc sống tươi đẹp vô cùng. Mươi mười lăm năm nữa thôi, các em sẽ thấy cũng dưới ánh trăng này, dòng thác nước đổ xuống làm chạy máy phát điện; ở giữa biển rộng, cờ đỏ sao vàng phấp phới bay trên những con tàu lớn. Trăng của các em sẽ soi sáng những ống khói nhà máy chi chít, cao thẳm, rải trên đồng lúa bát ngát vàng thơm, cùng với nông trường to lớn, vui tươi.

Trăng đêm nay sáng quá ! Trăng mai còn sáng hơn. Anh mừng cho các em vui Tết Trung thu độc lập đầu tiên và anh mong ước ngày mai đây, những tết trung thu tươi đẹp hơn nữa sẽ đến với các em.', 'Thép Mới', false, NULL);

-- Insert: ÔNG TRẠNG THẢ DIỀU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'ÔNG TRẠNG THẢ DIỀU', 'Vào đời vua Trần Thái Tông, có một gia đình nghèo sinh được cậu con trai đặt tên là Nguyễn Hiền. Chú bé rất ham thả diều. Lúc còn bé, chú đã biết làm lấy diều để chơi.
...
Thế rồi vua mở khoa thi. Chú bé thả diều đỗ Trạng nguyên. Ông Trạng khi ấy mới có mười ba tuổi. Đó là Trạng nguyên trẻ nhất của nước Nam ta.', 'Trinh Đường', false, NULL);

-- Insert: NGƯỜI TÌM ĐƯỜNG LÊN CÁC VÌ SAO
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'NGƯỜI TÌM ĐƯỜNG LÊN CÁC VÌ SAO', 'Từ nhỏ, Xi-ôn-cốp-xki đã mơ ước được bay lên bầu trời. Có lần, ông dại dột nhảy qua cửa sổ để bay theo những cánh chim. Kết quả, ông bị ngã gãy chân. Nhưng rủi ro lại làm nảy ra trong đầu óc non nớt của ông lúc bấy giờ một câu hỏi: "Vì sao quả bóng không có cánh mà vẫn bay được?".
...
Hơn bốn mươi năm khổ công nghiên cứu, tìm tòi, Xi-ôn-cốp-xki đã thực hiện được điều ông hằng tâm niệm: "Các vì sao không phải để tôn thờ mà là để chinh phục.".', 'Lê Nguyên Long – Phạm Ngọc Toàn', false, NULL);

-- Insert: CÂY BÀNG KHÔNG RỤNG LÁ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CÂY BÀNG KHÔNG RỤNG LÁ', 'Phố tôi có một cây bàng. Ai đã trồng cây bàng ấy, tôi không rõ. Chỉ biết rằng bây giờ cây đã to lắm rồi. Đến mùa quả chín, một mùi thơm ngòn ngọt, lờ lợ toả ra, lên mãi tận gác ba, gác tư.
...
Tôi vụt hiểu tất cả: Vì sao cây bàng không rụng lá.', 'Phong Thu', false, NULL);

-- Insert: TÀN NHANG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'TÀN NHANG', 'Trong một góc công viên, rất nhiều trẻ con đang xếp hàng chờ đợi một họa sĩ trang trí lên trên mặt để trở thành những “người da đỏ” hay “người ngoài hành tinh”,.... Một cậu bé cũng nắm tay bà chờ đến lượt mình. Mặt cậu bé rất nhiều đốm tàn nhang nhỏ, nhưng đôi mắt thì sáng lên vì háo hức.
...
Chim Sẻ nói cảm ơn liên hồi rồi cúi xuống mổ dồn dập.', 'Báo Nhi đồng số 8/2009', false, NULL);
...
– Khi con trai tôi còn đỏ hỏn, nó kẹt trong căn phòng bị hỏa hoạn. Lửa bén dữ quá nên không ai dám xông vào, thế là tôi liều mình. Vừa lao chạy tới bên nôi của cháu, tôi thấy một thanh xà sắp rơi xuống. Không kịp suy nghĩ, tôi liền ghé thân che cho con rồi bất tỉnh luôn. May mà một anh cứu hỏa đến kịp và cứu hai mẹ con tôi ra. Vết sẹo đã thành vĩnh viễn nhưng tôi không bao giờ hối hận về điều đó.

Nghe xong, chú nhỏ ùa tới ôm chầm lấy mẹ, nước mắt lưng tròng. Người cậu run lên vì xúc động. Đức hy sinh của mẹ thanh cao quá! Cả ngày, chú bé cứ nắm riết lấy mẹ không rời.', 'Những hạt giống tâm hồn', false, NULL);

-- Insert: MÙA THU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'MÙA THU', 'Mùa thu, những khu vườn đầy lá vàng xao động, trái bưởi bỗng tròn căng đang chờ đêm hội rằm phá cỗ. Tiếng đám sẻ non tíu tít nhảy nhót nhặt những hạt thóc còn vương lại trên mảnh sân vuông.
...
Mùa thu, vạt hoa cúc dại cũng nở bung hai bên đường. Những bông hoa cúc xinh xinh dịu dàng, lung linh như từng tia nắng nhỏ. Thảm cỏ may thì tím biếc đến nôn nao. Hoa cỏ may quấn quýt từng bước chân, theo tận vào lớp học. Tiếng đọc bài ngân nga vang ra ngoài cửa lớp, khiến chú chim đang nghiêng chiếc đầu nhỏ xinh tìm sâu trong kẽ lá cũng lích rích hót theo. Giọt nắng sớm mai như vô tình đậu lên trang vở mới, bừng sáng lung linh những ước mơ.', 'Huỳnh Thị Thu Hương', false, NULL);

-- Insert: ĐIỀU NÊN LÀM NGAY
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'ĐIỀU NÊN LÀM NGAY', 'Trong một khoá học về tâm lí học, vị giáo sư ra đề bài như sau: “Trong vòng một tuần, anh chị hãy đến gặp người mà mình quan tâm và nói với họ rằng anh chị yêu mến họ. Đó phải là người mà trước đây, hoặc đã lâu anh chị không nói những lời như vậy”.
...
Có một sự chuyển biến trên khuôn mặt bố tôi. Gương mặt ông giãn ra, những nếp nhăn dường như biến mất và ông bắt đầu khóc. Ông bước đến, ôm chầm lấy tôi và nói: “Bố cũng yêu con, con trai ạ! Nhưng bố chưa biết làm thế nào để có thể nói với con điều đó.”

Đó là thời khắc quý báu nhất trong đời tôi. Hai ngày sau, bố tôi đột ngột bị một cơn đau tim và vẫn còn nằm trong bệnh viện cho đến bây giờ. Nếu như tôi trì hoãn bộc lộ với bố, có lẽ tôi không còn cơ hội nào nữa”.', 'Đen-nít E. Man-nơ-rinh', false, NULL);

-- Insert: CÔ GIÁO VÀ HAI EM NHỎ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CÔ GIÁO VÀ HAI EM NHỎ', 'Nết sinh ra đã bất hạnh với bàn chân trái thiếu ba ngón. Càng lớn, đôi chân Nết lại càng teo đi và rồi Nết phải bò khi muốn di chuyển.
...
Bố mẹ Nết rơm rớm nước mắt khi biết nhà trường sẽ đặc cách cho Nết vào học lớp Hai. Còn Nết, cô bé đang hình dung cách cô giáo cùng các bạn nhỏ xúm xít đầy chiếc xe lăn.', 'Tâm huyết nhà giáo', false, NULL);

-- Insert: NIỀM TIN CỦA TÔI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'NIỀM TIN CỦA TÔI', 'Chưa bao giờ tôi nghĩ là mình có khả năng viết lách. Việc viết một bài thơ, một bài tiểu luận đối với tôi còn khó hơn cả việc “lên rừng, xuống biển”. Thế nhưng tôi lại rất yêu thích công việc này, nên quyết định tham gia một lớp học rèn luyện kĩ năng sáng tác.
...
Sau này, tôi đã viết thêm nhiều những cuốn sách, nhưng cuốn sách đầu tay của tôi là dành tặng riêng bà, dành tặng cho người đầu tiên khơi dậy những khả năng tiềm ẩn trong tôi, là người đã tạo cho tôi tự tin để thể hiện chính mình trên những trang viết.', 'Nhã Khanh', false, NULL);

-- Insert: HOA TÓC TIÊN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'HOA TÓC TIÊN', 'Thầy giáo dạy cấp một của tôi có một khoảnh vườn tí tẹo, chỉ độ vài mét vuông. Mọc um tùm với nhau là những thứ quen thuộc: xương sông, lá lốt, bạc hà, kinh giới. Có cả cây ớt lẫn cây hoa hồng lúc nào cũng bừng lên bông hoa rức rỡ. Đặc biệt là viền bốn xung quanh mảnh vườn có hàng tóc tiên, xanh và mềm quanh năm. Chắc là những cô tiên không bao giờ già, tóc không bao giờ bạc nên thứ cỏ này mới có tên gọi như thế.
...
Chim em ngoan ngoãn rúc vào cánh mẹ thay cho lời vâng ạ. Chim anh cũng ôm lấy em rồi cùng mẹ dìu em lên tổ.', 'Phong Thu', false, NULL);

-- Insert: TIẾNG HÁT BUỔI SỚM MAI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'TIẾNG HÁT BUỔI SỚM MAI', 'Rạng đông, mặt trời tỏa những tia nắng dịu dàng xuống muôn vật.
...
– Mỗi buổi sáng sớm, khi mặt trời bắt đầu sưởi ấm vạn vật, muôn loài đều hân hoan hát ca. Nhưng mỗi loài đều có tiếng hát của riêng mình. Có biết lắng nghe nhau mới hiểu được tiếng hát của nhau, các cháu ạ.', 'Truyện nước ngoài', false, NULL);

-- Insert: ĐỈNH FANSIPAN SA PA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'ĐỈNH FANSIPAN SA PA', 'Trong năm 2017, Sapa là một trong những điểm du lịch trong nước và quốc tế đặc biệt yêu thích. Nơi đây sở hữu những dãy núi hùng vĩ hay ruộng lúa bậc thang uốn lượn hút tầm mắt. Đặc biệt nhất trong đó là đỉnh Fansipan với độ cao 3143m và được mệnh danh là “Nóc nhà Đông Dương”. Đỉnh Fansipan thuộc dãy núi Hoàng Liên Sơn, nằm cách trung tâm thị trấn Sapa chừng 5km.
...
Thế nhưng giờ đây việc chinh phục đã trở nên đơn giản hơn rất nhiều nhờ hệ thống cáp treo nối tuyến thẳng chỉ mất 15 phút di chuyển nên đây càng được xem là điểm đến yêu thích nhất của năm 2017. Fansipan phù hợp cho những du khách đi du lịch một mình, du lịch cặp đôi, du lịch cùng gia đình,… theo hướng trải nghiệm và khám phá.', 'Văn hóa, phong tục Việt Nam', false, NULL);

-- Insert: CẦU LONG BIÊN - CHỨNG NHÂN LỊCH SỬ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CẦU LONG BIÊN - CHỨNG NHÂN LỊCH SỬ', 'Cầu Long Biên có một tuyến đường sắt chạy giữa. Hai bên là đường ô tô và hành lang ngoài cùng là tuyến dành cho người đi bộ. Nhưng kích thước ấy chỉ hợp với thời kỳ mà phương tiện đi lại còn ít, chủ yếu là các loại xe thô sơ. Những năm tháng hoà bình trước đây, cầu Long Biên từng được đưa vào sách giáo khoa. Tôi vẫn nhớ như in hình ảnh chiếc cầu được vẽ trang trọng giữa trang sách với bài thơ đã được bao thế hệ học thuộc lòng.

[...] Mỗi lần có dịp đứng trên cầu Long Biên, tôi lại say mê ngắm nhìn màu xanh bãi mía, nương dâu, bãi ngô, vườn chuối phía Gia Lâm không bao giờ chán mắt. Cái màu xanh cần lao ấy gợi bao yêu thương và yên tĩnh trong tâm hồn. Khi chiều xuống, nhìn về phía Hà Nội, thấy những ánh đèn mọc lên như sao sa, gợi lên bao quyến rũ và khát khao.', 'Thúy Lan', false, NULL);

-- Insert: NGƯỜI PHÁT MINH RA TÀU THUỶ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'NGƯỜI PHÁT MINH RA TÀU THUỶ', 'Rô-bớt Phun-tơn là một kĩ sư người Mỹ đã phát minh ra tàu thuỷ chạy bằng hơi nước. Ngay từ hồi còn nhỏ, vốn đam mê kĩ thuật, ông thường tự nêu lên các thắc mắc và tìm cách giải quyết bằng được mới thôi.

Năm 13 tuổi, một lần chèo thuyền đi câu cá với bạn, cậu bé Phun-tơn thấy công việc chèo thuyền thật vất vả, nhất là khi ngược gió. Cậu nói: – Nếu có thể có cái gì đó làm thay việc chèo thuyền thì hay biết mấy! Bạn cậu cười: – Xem kìa! Hàng trăm năm nay con người vẫn chèo thuyền đấy thôi, muốn thay đổi e là quá khó.
...
Liên tục cải tiến phát minh của mình, đến năm 43 tuổi, Phun-tơn đã chế tạo ra con tàu sử dụng động cơ hơi nước đầu tiên trên thế giới.', '100 câu chuyện hay dành cho bé trai', false, NULL);

-- Insert: BÔNG SEN TRONG GIẾNG NGỌC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'BÔNG SEN TRONG GIẾNG NGỌC', 'Mạc Đĩnh Chi người đen đủi, xấu xí. Nhà nghèo, mẹ con cậu nuôi nhau bằng nghề kiếm củi. Mới bốn tuổi, Mạc Đĩnh Chi đã tỏ ra rất thông minh. Bấy giờ, Chiêu quốc công Trần Nhật Duật mở trường dạy học, Mạc Đĩnh Chi xin được vào học. Cậu học chăm chỉ, miệt mài, sớm trở thành học trò giỏi nhất trường.

Kì thi năm ấy, Mạc Đĩnh Chi đỗ đầu nhưng vua thấy ông mặt mũi xấu xí, người bé loắt choắt, lại là con thường dân, toan không cho đỗ. Thấy nhà vua không trọng người hiền, chỉ trọng hình thức bề ngoài, Mạc Đĩnh Chi làm bài phú "Bông sen giếng ngọc" nhờ người dâng lên vua. Bài phú đề cao phẩm chất cao quý khác thường của loài hoa sen, cũng để tỏ rõ chí hướng và tài năng của mình. Vua đọc bài phú thấy rất hay, quyết định lấy ông đỗ Trạng nguyên.

Về sau, Mạc Đĩnh Chi nhiều lần được giao trọng trách đi sứ. Bằng tài năng của mình, ông đã đề cao được uy tín đất nước, khiến người nước ngoài phải nể trọng sứ thần Đại Việt. Vua Nguyên tặng ông danh hiệu Trạng nguyên. Nhân dân ta ngưỡng mộ, tôn xưng ông là: Lưỡng quốc Trạng nguyên (Trạng nguyên hai nước).', 'Lâm Ngữ Đường', false, NULL);

-- Insert: ĐƯỜNG ĐI SA PA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'ĐƯỜNG ĐI SA PA', 'Xe chúng tôi leo chênh vênh trên dốc cao của con đường xuyên tỉnh. Những đám mây trắng nhỏ sà xuống cửa kính ô tô tạo nên cảm giác bồng bềnh huyền ảo. Chúng tôi đang đi bên những thác trắng xoá tựa mây trời, những rừng cây âm âm, những bông hoa chuối rực lên như ngọn lửa. Tôi lim dim mắt ngắm mấy con ngựa đang ăn cỏ trong một vườn đào ven đường. Con đen huyền, con trắng tuyết, con đỏ son, chân dịu dàng, chùm đuôi cong lướt thướt liễu rủ.
...
Sa Pa quả là món quà tặng diệu kì mà thiên nhiên dành cho đất nước ta.', 'NGUYỄN PHAN HÁCH', false, NULL);

-- Insert: CÂU CHUYỆN VỀ MÙA ĐÔNG VÀ CHIẾC ÁO KHOÁC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CÂU CHUYỆN VỀ MÙA ĐÔNG VÀ CHIẾC ÁO KHOÁC', 'Mùa đông đã tới, những cơn gió rét buốt rít ngoài cửa sổ. Ngoài đường, ai cũng bước vội vàng để tránh cái lạnh đang làm cứng đờ đôi bàn tay. Những khuôn mặt vui tươi, hớn hở biến đi đâu mất, thay vào đó là tái đi vì lạnh. Mùa rét năm nay, mẹ mua cho An một chiếc áo khoác mới, vì áo cũ của cậu đa phần đã bị rách do sự hiếu động của An. Khi nhận chiếc áo từ mẹ, An vùng vằng vì kiểu dáng và màu sắc của chiếc áo không đúng ý thích của cậu. Về phòng, cậu ném chiếc áo xuống đất, cả ngày lầm lì không nói gì.
...
Bất giác, An cảm thấy hối hận vô cùng. An nhớ lại ánh mắt buồn của mẹ khi cậu ném chiếc áo khoác xuống đất. Bố chỉ nhẹ nhàng: “Con có hiểu không? Cuộc đời này còn nhiều người thiệt thòi lắm. Hãy biết trân trọng thứ mà mình đang có.”', NULL, false, NULL);

-- Insert: ĐẤT RỪNG PHƯƠNG NAM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'ĐẤT RỪNG PHƯƠNG NAM', 'Thoáng cái, tôi đã đặt chân lên bờ. Chao ôi! Chợ gì mà lạ lùng thế này?
...
Có tiếng chim gì mổ nhau kêu quang quác trong chiếc lồng kẽm chỗ tôi tối: ngọn đèn vừa bị cánh chim đánh nhau quạt tắt, người chủ bán chưa kịp thắp lên. Một chú khỉ con cứ nhảy qua nhảy lại lia lịa, chờn vờn trèo lên đống bí ngô. Thấy tôi đi qua, nó nhe răng khẹc khẹc, ngó tôi rồi quay lại nhòm người chủ, dường như muốn bảo tôi hỏi giùm tại sao ông ta không thả mối dây xích cổ ra để nó được tự do đi chơi như tôi…', 'Đoàn Giỏi', false, NULL);

-- Insert: CHIỀN CHIỆN BAY LÊN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CHIỀN CHIỆN BAY LÊN', 'Đã vào mùa thu...
...
Sau câu chuyện kì lạ ấy, ở nhiều thành phố Hi Lạp và La Mã đã xuất hiện những đồng tiền khắc hình một con cá heo cõng người trên lưng. Có lẽ đó là đồng tiền được ra đời để ghi lại tình cảm yêu quý con người của loài cá thông minh.', NULL, false, NULL);

-- Insert: MỘT CHIỀU CUỐI THU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'MỘT CHIỀU CUỐI THU', 'Trời như một chiếc dù xanh bay mãi lên cao. Các hồ nước quanh làng như mỗi lúc một sâu hơn. Chúng không còn là hồ nước nữa, chúng là những cái giếng không đáy, ở đó ta có thể nhìn thấy bầu trời bên kia trái đất.
...
Chúng cứ hát mãi, hát mãi, hát mãi cho đến lúc những ngọn khói tan biến vào không gian mênh mông…', 'Nguyễn Trọng Tạo', false, NULL);

-- Insert: MÙA THẢO QUẢ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'MÙA THẢO QUẢ', 'Thảo quả trên rừng Đản Khao đã chín nục. Chẳng có thứ quả nào hương thơm lại ngây ngất kì lạ đến như thế. Mới đầu xuân năm kia, những hạt thảo quả gieo trên đất rừng, qua một năm, đã lớn cao tới bụng người. Một năm sau nữa, từ một thân lẻ, thảo quả đâm thêm hai nhánh mới. Sự sinh sôi sao mà mạnh mẽ vậy. Thoáng cái, dưới bóng râm của rừng già, thảo quả lan tỏa nơi tầng rừng thấp, vươn ngọn, xòe lá, lấn chiếm không gian.

Sự sống cứ tiếp tục trong âm thầm, hoa thảo quả nảy dưới gốc cây kín đáo và lặng lẽ. Ngày qua, trong sương thu ẩm ướt và mưa rây bụi mùa đông, những chùm hoa khép miệng bắt đầu kết trái. Thảo quả chín dần. Dưới đáy rừng, tựa như đột ngột, bỗng rực lên những chùm thảo quả đỏ chon chót, như chứa lửa, chứa nắng. Rừng ngập hương thơm. Rừng sáng như có lửa hắt lên từ dưới đáy rừng.

Rừng say ngây và ấm nóng. Thảo quả như những đốm lửa hồng, ngày qua ngày lại tiếp thêm nhiều ngọn mới, nhấp nháy vui mắt.', 'Ma Văn Kháng', false, NULL);

-- Insert: CẬU BÉ DŨNG CẢM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CẬU BÉ DŨNG CẢM', 'Một cậu bé mười tuổi rất hiếu động, nghịch ngợm. Một hôm cha cậu được người ta tặng cho một chiếc rìu. Vô cùng thích thú với chiếc rìu sáng loáng, cậu bé liền nảy ra một ý nghĩ: “Hay là mình chặt thử cây anh đào này đi, coi thử chiếc rìu này có bén không.”.
...
- Sự trung thực của con đáng giá gấp ngàn lần cây anh đào đó con ạ.', 'Vạn điều hay', false, NULL);

-- Insert: CÁNH CHIM THIÊN NGA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CÁNH CHIM THIÊN NGA', 'Mùa đông năm ấy, trời rất lạnh. Một đàn thiên nga trắng bay về phương Nam để trú đông. Trong đàn có một chú thiên nga nhỏ lần đầu tiên rời xa quê hương.
...
Nhiều năm sau, khi cô bé đã trở thành một họa sĩ nổi tiếng với những bức tranh về thiên nga, cô vẫn nhớ mãi người bạn đầu tiên đã cho cô niềm tin và hy vọng để theo đuổi ước mơ của mình.', 'Nguyễn Thu Hương', false, NULL);

-- Insert: MÙA THU TRONG TÔI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'MÙA THU TRONG TÔI', 'Mùa thu đến, mang theo những cơn gió nhẹ, những làn mây trắng bồng bềnh trên bầu trời trong xanh. Cái lạnh se se của mùa thu như thấm vào từng thớ đất, từng ngọn cây. Lúc này, cây cối không còn xanh mướt như mùa hè mà bắt đầu chuyển sang màu vàng, màu đỏ, những chiếc lá rụng xuống phủ kín trên mặt đất.

Mùa thu cũng là mùa của những trái chín, của những cánh đồng lúa vàng óng, chờ ngày gặt hái. Những con chim trên bầu trời bay lượn về phương nam, mang theo nỗi nhớ mùa thu. Còn con người, ai ai cũng cảm thấy lòng mình trở nên dịu lại, nhẹ nhàng hơn trong tiết trời mùa thu. Mùa thu là mùa của sự yên bình, của những kỷ niệm ngọt ngào, của những chiều tà ngồi bên hiên nhà, ngắm nhìn hoàng hôn tắt dần sau núi.

Đối với tôi, mùa thu luôn gợi lên một cảm giác thân thuộc, như thể mùa thu đã ở trong tôi từ rất lâu rồi, từ những ngày thơ ấu. Cứ mỗi lần mùa thu đến, tôi lại cảm thấy yêu thêm những gì giản dị, bình yên xung quanh mình.', 'Nguyễn Quang Sáng', false, NULL);

-- Insert: NHỮNG BÀI HỌC TỪ THIÊN NHIÊN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'NHỮNG BÀI HỌC TỪ THIÊN NHIÊN', 'Chú ong nhỏ sống trong một tổ ong dưới gốc cây to trong khu vườn nhà bà nội. Mỗi sáng, khi mặt trời vừa ló dạng, chú ong đã thức dậy, vươn mình, vỗ đôi cánh mỏng manh rồi bay đi tìm hoa mật. Công việc của chú ong luôn là một chuỗi hành động không ngừng nghỉ, từ sáng cho đến tối.
...
Một hôm, bà nội kể cho tôi nghe về một câu chuyện thú vị. Bà nói rằng "Chú ong là biểu tượng của sự cần mẫn, chăm chỉ. Nhờ có những chú ong như vậy mà chúng ta có mật, có phấn hoa và cả những mùa xuân rực rỡ." Tôi nhìn theo hình ảnh chú ong cần mẫn bay về tổ, cảm thấy vô cùng ngưỡng mộ và học hỏi được nhiều điều từ sự chăm chỉ của nó.', 'Nguyễn Duy Bình', false, NULL);

-- Insert: NGƯỜI BẠN CỦA CÂY
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'NGƯỜI BẠN CỦA CÂY', 'Trong một khu vườn nhỏ của trường tiểu học Hoa Mai, có một cậu bé tên Nam rất yêu thích việc chăm sóc cây cối. Mỗi sáng đến trường, Nam đều dành ra mười phút để tưới nước cho những chậu hoa và bón phân cho các loại cây. Các bạn trong lớp thường gọi đùa Nam là "người bạn của cây".
...
Cuối năm học, khu vườn của lớp Nam đã đạt giải nhất cuộc thi. Nhưng với Nam, phần thưởng lớn nhất chính là niềm vui khi thấy các bạn trong trường cũng bắt đầu yêu thích và học cách chăm sóc cây cối. Từ đó, trường học của Nam luôn xanh tươi và tràn ngập những nụ cười.', 'Tạp chí Thiếu nhi Việt Nam', false, NULL);

-- Insert: MỘT NGÀY THỰC TẾ CỦA NHỮNG NGƯỜI THỢ CẮT CỎ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'MỘT NGÀY THỰC TẾ CỦA NHỮNG NGƯỜI THỢ CẮT CỎ', 'Mỗi sáng sớm, khi những tia nắng đầu tiên bắt đầu chiếu sáng mặt đất, những người thợ cắt cỏ đã bắt đầu công việc của mình. Công việc này đòi hỏi sự kiên nhẫn và sự chăm chỉ. Những người thợ cắt cỏ thường làm việc ngoài trời, phải đối mặt với thời tiết nắng nóng hay những ngày mưa ướt át.

Công việc của họ bắt đầu từ việc mang theo các công cụ như máy cắt cỏ, kéo cắt và găng tay bảo vệ. Họ đi khắp các khu vườn, công viên, hoặc các đồng cỏ, để cắt cỏ cho gọn gàng. Đôi khi, họ còn phải làm công việc dọn dẹp những cây cỏ dại hay những mảng cỏ đã mọc quá dài.

Ngoài việc cắt cỏ, những người thợ cắt cỏ còn phải chăm sóc cho cây cối, tưới nước và bảo vệ chúng khỏi sâu bọ. Mặc dù công việc khá vất vả, nhưng những người thợ cắt cỏ luôn cảm thấy tự hào vì công việc của mình giúp cho không gian sống trở nên sạch đẹp và xanh tươi hơn.

Mỗi ngày kết thúc, họ thu dọn dụng cụ, nhìn lại những khu vực đã hoàn thành và cảm thấy vui vì đã đóng góp công sức vào việc tạo ra một môi trường sống tốt đẹp hơn cho mọi người.', 'Sách Cuộc sống mỗi ngày', false, NULL);

-- Insert: CÔ BÉ CHÂN NHỰA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CÔ BÉ CHÂN NHỰA', 'Lê sống cùng bố mẹ và em trai trên một ngọn đồi nhỏ xanh ngát. Từ khi sinh ra, Lê chỉ có một chân nên đi lại rất khó khăn. Ở trường, các bạn gọi Lê là “Lê chân nhựa”.
...
Bố mẹ và em trai nép sau gốc chà là xúc động nhìn Lê, mắt ướt nhòe đi.', 'Nhung Ly', false, NULL);

-- Insert: MÀU SẮC TỪ TRÁI TIM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'MÀU SẮC TỪ TRÁI TIM', 'Từ khi sinh ra, Lâm đã không thể phân biệt được màu sắc. Với cậu, màu xanh, màu đỏ hay màu vàng đều chỉ là tên gọi. Một ngày nọ, khi đi dạo đến chân núi, Lâm gặp một cô bé đang ngồi vẽ tranh.
...
Cô nhìn tôi như một người cho. Cô làm cho tôi thành người có trách nhiệm. Cô tin tôi có thể có một cái gì để trao cho người khác. Cô chấp nhận tôi như thành viên của cùng một thế giới mà cô đang sống. Tôi bước ra khỏi phòng, tay giữ chặt kính trong tay, không phải như kẻ vừa được nhận một món quà, mà như người chuyển tiếp món quà đó cho người khác với tấm lòng tận tụy.', 'Xuân Lương', false, NULL);

-- Insert: KHÔNG NGỪNG NỖ LỰC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'KHÔNG NGỪNG NỖ LỰC', 'Ga-ri Play-ơ đã từng là một đấu thủ lừng danh trong các giải thi đánh gôn quốc gia và quốc tế trong nhiều năm trời. Mọi người thường nói với anh là: “Tôi sẽ đánh đổi bất cứ thứ gì để có thể đập được một cú gôn như anh”.
...
Mọi việc chẳng phải lúc nào cũng dễ dàng cả đâu, nhưng rất đáng công để bạn phải nỗ lực đấy!', 'Xti-vơ Gu-đi-ơ', false, NULL);

-- Insert: TÌNH THƯƠNG CỦA ANH
INSERT INTO contexts (grade, subject, content, author) VALUES 
(5, 'TV', '<h1 align="center">TÌNH THƯƠNG CỦA ANH</h1>\n\nCô bé kéo sợi dây đu khiến cho chiếc đu ngày càng bay cao. Gió thổi mát lạnh. Cô bé 5 tuổi đang giận dỗi ông anh lên 11 của mình là Đa-vít (David).
...
Tôi chính là cô bé thuở ấy và kể từ lúc đó, mỗi lần anh trêu là "bé bự”, tôi chỉ phì cười. Tôi biết là anh tôi yêu thương tôi. Anh không cần phải đối đầu với một con trâu càn để chứng minh lòng yêu thương em của mình. Nhưng tôi vẫn nhớ cái ngày mà anh tôi đã chứng tỏ lòng thương yêu ấy.', 'Diana L. James (Hải Châu dịch)', false, NULL);

-- Insert: NGÀY HẠNH PHÚC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'NGÀY HẠNH PHÚC', 'Hôm nay, trường tôi tổ chức ngày hội “Mẹ và con”. Trong ngày này, các con sẽ cùng mẹ tham gia nhiều hoạt động ý nghĩa ở trường. Tôi đứng ngắm sân trường nhộn nhịp như một lễ hội với các gian hàng, các trò chơi và sân khấu biểu diễn nghệ thuật. Một nỗi buồn len nhẹ vào trái tim tôi.
...
Ngày hội kết thúc, bố và tôi bước ra khỏi cổng trường trong những ánh mắt ngưỡng mộ. Bố – người hùng đã không chỉ chiếm được trái tim của tôi, mà còn của mọi người xung quanh. Tôi tự hào về bố. Đó là một ngày hạnh phúc mà tôi sẽ không bao giờ quên.', 'Mai Hiền', false, NULL);

-- Insert: BỘ LÔNG RỰC RỠ CỦA CHIM THIÊN ĐƯỜNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'BỘ LÔNG RỰC RỠ CỦA CHIM THIÊN ĐƯỜNG', 'Chim thiên đường đi tha rác về lót ổ, chuẩn bị cho mùa đông đang tới gần. Nó bay rất xa, chọn những chiếc lá vàng, lá đỏ thật đẹp, những ngọn cỏ thật thơm, thật mềm.
...
Từ đó, thiên đường luôn khoác trên mình một chiếc áo nhiều màu rực rỡ, vật kỉ niệm thiêng liêng của biết bao loài chim bạn bè.', 'Trần Hoài Dương', false, NULL);

-- Insert: RỪNG GỖ QUÝ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'RỪNG GỖ QUÝ', 'Xưa có vùng đất toàn đồi cỏ tranh hoặc tre nứa. Gia đình nhà họ có bốn người phải sống chui rúc trong gian lều ọp ẹp và chật chội.
...
Chỉ trong ít phút ngắn ngủi, câu chuyện chiếc đồng hồ của Bác đã khiến cho ai nấy đều thấm thía, tự đánh tan được những thắc mắc riêng tư.', 'Sách Bác Hồ kính yêu', false, NULL);

-- Insert: MỒ CÔI XỬ KIỆN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'MỒ CÔI XỬ KIỆN', 'Ngày xưa, ở một vùng quê nọ, có chàng Mồ Côi rất nhanh nhẹn, công tâm. nên được người dân tin tưởng giao cho việc xử kiện.
...
Nói xong, Mồ Côi trả hai đồng bạc cho bác nông dân rồi tuyên bố kết thúc phiên xử. Bác nông dân thở phào nhẹ nhõm, còn ông chủ quán đành lẳng lặng ra về, không dám kêu ca gì.', 'Truyện dân gian dân tộc Nùng', false, NULL);

-- Insert: GIỜ HỌC VẼ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'GIỜ HỌC VẼ', 'Trong giờ học Mĩ thuật, thầy giáo yêu cầu các bạn học sinh vẽ một bức tranh về chủ đề "Địa điểm em yêu thích". Bức tranh đẹp nhất sẽ được treo ở góc học tập của lớp. Sau khi nhận được đề bài, cả lớp bắt đầu xôn xao:

- Tớ sẽ vẽ công viên có hồ nước trong xanh, mát mẻ. - Trang vui vẻ nói.

- Minh sẽ vẽ một quán cà phê đầy lá vàng rơi và ánh nắng mặt trời đang lọt qua từng kẽ lá. - Hoàng hồ hởi.

- Chà! Nghe hay đấy! Tớ nghĩ bức tranh của cậu sẽ rất đẹp và thơ mộng. - Trang nói với ánh mắt ngưỡng mộ.

- Còn cậu thì sao Linh? Cậu sẽ vẽ gì vậy? - Trang quay sang hỏi Linh.

- Vì tớ thích mùa hè và thích cảm giác được đi trên cát nên tớ sẽ vẽ một bức tranh về biển cả. Trong bức tranh sẽ có hàng dừa xanh đung đưa trong gió, có từng đợt sóng nhấp nhô vỗ vào bờ, có các bạn nhỏ đang tắm biển và xây lâu đài cát.

- Thích quá! Chắc bức tranh của cậu sẽ rất sôi động và tươi sáng cho mà xem. - Hoàng hào hứng nói.

Rồi các bạn bắt đầu vẽ tranh, tô lên đó những màu sắc rực rỡ và hoàn thiện chúng. Ai nấy cũng đều vui sướng. Sau giờ học, các bạn nhận ra rằng nghệ thuật sẽ mang lại sắc màu cho cuộc sống.', 'Hồng Thư', false, NULL);

-- Insert: NGHỀ LÀM GỐM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'NGHỀ LÀM GỐM', 'Trong một buổi sáng nắng đẹp, cô Linh tổ chức cho cả lớp một chuyến đi tham quan đến làng gốm Bát Tràng ở Hà Nội.
...
Chúng em hi vọng sẽ được đi trải nghiệm thêm nhiều làng nghề truyền thống hơn nữa.', 'Hồng Thư', false, NULL);

-- Insert: GẤP GIẤY
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'GẤP GIẤY', 'Thầy Đa-vít chậm rãi bước lên bục giảng. Đột nhiên, thầy rút từ trong túi xách ra một tờ giấy A4 và khẽ gấp đôi lại.
...
Thầy vừa dứt lời, cả lớp vỗ tay rào rào thán phục và cảm ơn bài học đáng quý của thầy.', 'Nhung Ly', false, NULL);

-- Insert: TẠI SAO MẸ LẠI KHÓC?
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'TẠI SAO MẸ LẠI KHÓC?', 'Một cậu bé hỏi mẹ:
...
Để làm được những việc nhọc nhằn đó, Người đã cho họ những giọt nước mắt để rơi, để họ sử dụng bất cứ lúc nào và đấy là điểm yếu duy nhất của họ. Khi con thấy họ khóc, hãy nói với họ con yêu họ biết bao và nếu họ vẫn khóc, con hãy làm trái tim họ được bình yên.”', 'Võ Đức Duy', false, NULL);

-- Insert: CON THÍCH LÀM NÔNG DÂN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CON THÍCH LÀM NÔNG DÂN', 'Cuối tuần, An được mẹ dẫn đi chơi công viên. Ở các tòa nhà trong thành phố, người ta dán rất nhiều áp phích về xây dựng nông thôn mới. Trông thấy thế, An tò mò hỏi mẹ: “Mẹ ơi, ai sẽ xây dựng nông thôn mới ạ?”. Mẹ An cười và đáp: “Các bác nông dân sẽ xây dựng nông thôn mới con ạ.”.
...
Mẹ dịu dàng nắm tay An, âu yếm nhìn con: “Ừ! Chỉ cần con yêu thích và cố gắng làm tốt công việc của mình, thì nghề nào cũng quý con ạ.”. Thế rồi, hai mẹ con vui vẻ rảo bước trong công viên đầy nắng.', 'Nhung Ly', false, NULL);

-- Insert: CHUYỆN VẼ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CHUYỆN VẼ', 'An rất thích vẽ tranh. Một lần tình cờ, An quen ông Minh - một nghệ nhân làm gốm. Ông chia sẻ: "Nghề này cũng giống như cháu vẽ tranh vậy, có thể thoả sức sáng tạo. Bởi chúng đều là nghệ thuật. Mà nghệ thuật thì không có giới hạn.". Lắng nghe lời ông Minh nói, nhìn đôi bàn tay ông nặn từng bình gốm, An dần cảm nhận được sự thú vị và đẹp đẽ của nghề gốm. Cậu quyết định mang vẻ đẹp này vào tranh của mình. Cậu vẽ một bức tranh rực rỡ về làng gốm. Nhưng ngay khi bức tranh sắp hoàn thành, cơn mưa bất chợt kéo đến và làm ướt tranh của cậu. An buồn lắm. Ông Minh thấy vậy lại nói: "Nghệ thuật đôi khi còn đến từ chính nỗi buồn nữa đấy An ạ!". Nghe xong, An chợt hiểu ra rằng nghệ thuật không chỉ là cầm bút lên vẽ hay tạo hình một khối đất sét, mà nó còn là cách để thể hiện cảm xúc của bản thân. Thể là, cậu lại vẽ một bức tranh mới bằng chính cảm xúc lúc này của mình.', 'Hồng Thư', false, NULL);

-- Insert: HAI MẸ CON
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'HAI MẸ CON', 'Lần đầu mẹ đưa Phương vào lớp 1, cô giáo kêu mẹ ký tên vào sổ, mẹ bẽn lẽn nói: “Tôi không biết chữ!”. Phương thương mẹ quá! Nó quyết định học cho biết chữ để chỉ giúp mẹ cách ký tên.
...
Tiếng vỗ tay làm Phương bừng tỉnh. Mọi con mắt đổ dồn về phía nó. Nó cúi gằm mặt xuống, cảm thấy ngượng nghịu và xấu hổ. Vậy mà nó đã giận mẹ!', 'Nguyễn Thị Hoan', false, NULL);

-- Insert: THÁI SƯ TRẦN THỦ ĐỘ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'THÁI SƯ TRẦN THỦ ĐỘ', 'Trần Thủ Độ là người có công lập nên nhà Trần, lại là chú của vua và đứng đầu trăm quan, nhưng không vì thế mà tự cho mình vượt qua phép nước.
...
- Quả có chuyện như vậy. Xin Bệ hạ quở trách thần và ban thưởng cho người nói thật.', 'Đại Việt sử kí toàn thư', false, NULL);

-- Insert: CON ĐƯỜNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CON ĐƯỜNG', 'Tôi là một con đường, một con đường nhỏ thôi, nhưng cũng khá lớn tuổi rồi. Hàng ngày đi qua tôi là bao nhiêu con người với biết bao bước chân khác nhau. Tôi ôm ấp những bước chân ấy trong lòng đầy yêu mến!
...
Biết tin, cha mẹ Lan chạy đến. Cả hai cô chú ôm chầm lấy Vịnh, xúc động không nói nên lời.', 'Tô Phương', false, NULL);

-- Insert: GIÓ LẠNH ĐẦU MÙA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'GIÓ LẠNH ĐẦU MÙA', 'Sáng nay, gió mùa đông bắc thổi về, trời bỗng lạnh. Những cơn gió làm cho lá khô bay lả tả trên mặt đất, người đi đường vội vã hơn, ai cũng khoác thêm áo ấm.
...
Lúc đó, Sơn cảm thấy lòng mình ấm áp lạ thường, dù gió mùa đông bắc vẫn thổi từng cơn lạnh buốt.', 'Thạch Lam', false, NULL);

-- Insert: ĐÀN CHIM GÁY
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'ĐÀN CHIM GÁY', 'Bây giờ đang là mùa gặt tháng Mười, hàng đàn chim gáy cắn đuôi nhau, lượn vòng rồi sà xuống ruộng gặt.
...
Tôi rất thích chim gáy. Con chim gáy phúc hậu và chăm chỉ, con chim gáy mơ màng, con chim gáy no ấm của mùa gặt hái tháng Mười.', 'Tô Hoài', false, NULL);

-- Insert: CÂY TRÁM ĐEN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CÂY TRÁM ĐEN', 'Ở đầu bản tôi có mấy cây trám đen. Thân cây cao vút, thẳng như một cột nước từ trên trời rơi xuống. Cành cây mập mạp, nằm ngang, vươn toả như những gọng ô. Trên cái gọng ô ấy xoè tròn một chiếc ô xanh ngút ngát. Lá trám đen chỉ to bằng bàn tay đứa trẻ lên ba, nhưng dài chừng một gang.
...
"Con biết không, trồng cây giống như nuôi dưỡng ước mơ. Cần có kiên nhẫn, chăm chỉ và tình yêu." – Ông nội nói.', 'Minh Ngọc', false, NULL);


-- DUPLICATED contextsS ACROSS GRADES
-- Duplicate: TRÍ KHÔN (From Grade 1 to 2)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'TRÍ KHÔN', 'Một hôm, nom thấy bác thợ cày bảo gì trâu phải nghe nấy, Cọp lấy làm lạ hỏi:
...
-- Duplicate: CON QUẠ THÔNG MINH (From Grade 1 to 2)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CON QUẠ THÔNG MINH', 'Có một con quạ khát nước. Nó tìm thấy một cái lọ nước. Nhưng nước trong lọ quá ít, cổ lọ lại cao, nó không sao thò mỏ vào uống được. Nó nghĩ ra một cách: nó lấy mỏ gắp từng viên sỏi bỏ vào lọ. Một lúc sau, nước dâng lên, quạ tha hồ uống.', NULL, false, NULL);

-- Duplicate: TẤM CÁM (From Grade 1 to 2)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'TẤM CÁM', 'Tấm và Cám là hai chị em cùng cha khác mẹ! Ngày kia, dì ghẻ bảo hai chị em ra đồng xúc tép. Tấm siêng năng bắt được giỏ đầy. Cám ham chơi chẳng bắt được gì.', NULL, false, NULL);

-- Duplicate: SƠN TINH, THỦY TINH (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'SƠN TINH, THỦY TINH', '1. Hùng Vương thứ mười tám có một người con gái đẹp tuyệt trần, tên là Mị Nương. Nhà vua muốn kén cho công chúa một người chồng tài giỏi.
...
-- Duplicate: CHUYỆN QUẢ BẦU (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'CHUYỆN QUẢ BẦU', 'Ngày xưa có vợ chồng nọ đi rừng, bắt được một con dúi. Dúi xin tha, họ thương tình tha cho nó.
...
-- Duplicate: BÀI HỌC VỀ CHỮ TÍN (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'BÀI HỌC VỀ CHỮ TÍN', 'Hồi ở Pác Bó, Bác Hồ sống rất chan hòa với mọi người. Một hôm được tin Bác đi công tác xa, một trong những em bé thường ngày quấn quýt bên Bác chạy đến cầm tay Bác thưa:
...
-- Duplicate: CÂY ĐA QUÊ HƯƠNG (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'CÂY ĐA QUÊ HƯƠNG', 'Cây đa nghìn năm đã gắn liền với thời thơ ấu của chúng tôi. Đó là cả một tòa cổ kính hơn là một thân cây. Chín, mười đứa bé chúng tôi bắt tay nhau ôm không xuể. Cành cây lớn hơn cột đình. Ngọn chót vót giữa trời xanh. Rễ cây nổi lên mặt đất thành những hình thù quái lạ, như những con rắn hổ mang giận dữ. Trong vòm lá, gió chiều gẩy lên những điệu nhạc li kì tưởng chừng như ai đang cười đang nói.

Chiều chiều, chúng tôi ra ngồi gốc đa hóng mát. Lúa vàng gợn sóng. Xa xa, giữa cánh đồng, đàn trâu ra về, lững thững từng bước nặng nề. Bóng sừng trâu dưới ánh chiều kéo dài, lan giữa ruộng đồng yên lặng.', 'NGUYỄN KHẮC VIỆN', false, NULL);

-- Duplicate: HŨ BẠC CỦA NGƯỜI CHA (From Grade 3 to 4)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'HŨ BẠC CỦA NGƯỜI CHA', 'Ngày xưa, có một nông dân người Chăm rất siêng năng. Về già, ông để dành được một hũ bạc. Tuy vậy, ông rất buồn vì người con trai lười biếng. Một hôm, ông bảo con:
...
-- Duplicate: SỰ TÍCH HOA CÚC TRẮNG (From Grade 3 to 4)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'SỰ TÍCH HOA CÚC TRẮNG', 'Ngày xưa có một cô bé sống cùng mẹ trong một túp lều tranh dột nát nhưng đó là một bé gái vô cùng hiếu thảo. Thật không may mẹ của cô bé lại bị bệnh rất nặng nhưng vì nhà nghèo nên ko có tiền mua thuốc chữa, và cô bé vô cùng buồn bã.
...
-- Duplicate: CA HUẾ TRÊN SÔNG HƯƠNG (From Grade 3 to 4)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'CA HUẾ TRÊN SÔNG HƯƠNG', 'Đêm. Thành phố lên đèn như sao sa. Màn sương dày dần lên, cảnh vật mờ đi trong một màu trắng đục. Tôi như một lữ khách thích giang hồ với hồn thơ lai láng, tình người nồng hậu bước xuống một con thuyền rồng, có lẽ con thuyền này kia chỉ dành cho vua chúa. Trước mũi thuyền là một không gian rộng thoáng để vua hóng mát ngắm trăng, giữa là một sàn gỗ bào nhẵn có mui vòm được trang trí lộng lẫy, xung quanh thuyền có hình rồng và trước mũi là một đầu rồng như muốn bay lên. Trong khoang thuyền, dàn nhạc gồm đàn tranh, đàn nguyệt, tì bà, nhị, đàn tam. Ngoài ra còn có đàn bầu, sáo và cặp sanh để gõ nhịp.

Các ca công còn rất trẻ, nam mặc áo dài the, quần thụng, đầu đội khăn xếp, nữ mặc áo dài, khăn đóng duyên dáng. Huế chính là quê hương chiếc áo dài Việt Nam. Những chiếc áo dài đầu tiên hiện còn được lưu giữ tại Bảo tàng Mĩ thuật cung đình Huế.

Trăng lên. Gió mơn man dìu dịu. Dòng sông trăng gợn sóng. Con thuyền bồng bềnh. Đêm nằm trên dòng Hương thơ mộng để nghe ca Huế, với tâm trạng chờ đợi rộn lòng.', 'Hà Ánh Minh', false, NULL);

-- Duplicate: SỰ TÍCH SÔNG HỒ Ở TÂY NGUYÊN (From Grade 3 to 4)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(4, 'TV', 'SỰ TÍCH SÔNG HỒ Ở TÂY NGUYÊN', 'Ngày xưa, muông thú còn sống thành buôn làng, quanh một cái hồ lớn. Cuộc sống thật tươi vui, đầm ấm.
...
-- Duplicate: NGƯỜI ĂN XIN (From Grade 4 to 5)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'NGƯỜI ĂN XIN', 'Lúc ấy, tôi đang đi trên phố. Một người ăn xin già lọm khọm đứng ngay trước mặt tôi. Đôi mắt ông lão đỏ đọc và giàn giụa nước mắt. Đôi môi tái nhợt, áo quần tả tơi thảm hại... Chao ôi! Cảnh nghèo đói đã gặm nát con người đau khổ kia thành xấu xí biết nhường nào!
...
-- Duplicate: ĐẤT RỪNG PHƯƠNG NAM (From Grade 4 to 5)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'ĐẤT RỪNG PHƯƠNG NAM', 'Thoáng cái, tôi đã đặt chân lên bờ. Chao ôi! Chợ gì mà lạ lùng thế này?

Một con ba ba to gần bằng cái nong, đặt lật ngửa, cứ ngọ nguậy bơi bơi bốn chân, trước ông cụ già ngồi lim dim đôi mắt. Những con rùa vàng to gần bằng cái tô, đều tăm tắp như đổ ở cùng một khuôn ra, nằm rụt cổ trong mấy chiếc giỏ cần xé. Đây là một con nai người ta vừa xẻ thịt ra bán, cái thủ còn nguyên chưa lột da bày giữa đống thịt đỏ hỏn trên một tấm lá chầm. Cua biển cũng có, ếch cũng có, nghêu sò cũng có. Còn cá tôm thì nhiều lắm, đủ các loại cá, loại tôm, không kể xiết.

Có tiếng chim gì mổ nhau kêu quang quác trong chiếc lồng kẽm chỗ tôi tối: ngọn đèn vừa bị cánh chim đánh nhau quạt tắt, người chủ bán chưa kịp thắp lên. Một chú khỉ con cứ nhảy qua nhảy lại lia lịa, chờn vờn trèo lên đống bí ngô. Thấy tôi đi qua, nó nhe răng khẹc khẹc, ngó tôi rồi quay lại nhòm người chủ, dường như muốn bảo tôi hỏi giùm tại sao ông ta không thả mối dây xích cổ ra để nó được tự do đi chơi như tôi…', 'Đoàn Giỏi', false, NULL);

-- Duplicate: CẦU LONG BIÊN - CHỨNG NHÂN LỊCH SỬ (From Grade 4 to 5)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CẦU LONG BIÊN - CHỨNG NHÂN LỊCH SỬ', 'Cầu Long Biên có một tuyến đường sắt chạy giữa. Hai bên là đường ô tô và hành lang ngoài cùng là tuyến dành cho người đi bộ. Nhưng kích thước ấy chỉ hợp với thời kỳ mà phương tiện đi lại còn ít, chủ yếu là các loại xe thô sơ. Những năm tháng hoà bình trước đây, cầu Long Biên từng được đưa vào sách giáo khoa. Tôi vẫn nhớ như in hình ảnh chiếc cầu được vẽ trang trọng giữa trang sách với bài thơ đã được bao thế hệ học thuộc lòng.

[...] Mỗi lần có dịp đứng trên cầu Long Biên, tôi lại say mê ngắm nhìn màu xanh bãi mía, nương dâu, bãi ngô, vườn chuối phía Gia Lâm không bao giờ chán mắt. Cái màu xanh cần lao ấy gợi bao yêu thương và yên tĩnh trong tâm hồn. Khi chiều xuống, nhìn về phía Hà Nội, thấy những ánh đèn mọc lên như sao sa, gợi lên bao quyến rũ và khát khao.', 'Thúy Lan', false, NULL);

-- Duplicate: TRUNG THU ĐỘC LẬP (From Grade 4 to 5)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'TRUNG THU ĐỘC LẬP', 'Đêm nay anh đứng gác ở trại. Trăng ngàn và gió núi bao la khiến lòng anh man mác nghĩ tới trung thu và nghĩ tới các em. Trăng đêm nay soi sáng xuống nước Việt Nam độc lập yêu quý của các em.Trăng sáng mùa thu vằng vặc chiếu khắp thành phố, làng mạc, núi rừng, nơi quê hương thân thiết của các em…
...
-- Duplicate: NGƯỜI TÌM ĐƯỜNG LÊN CÁC VÌ SAO (From Grade 4 to 5)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'NGƯỜI TÌM ĐƯỜNG LÊN CÁC VÌ SAO', 'Từ nhỏ, Xi-ôn-cốp-xki đã mơ ước được bay lên bầu trời. Có lần, ông dại dột nhảy qua cửa sổ để bay theo những cánh chim. Kết quả, ông bị ngã gãy chân. Nhưng rủi ro lại làm nảy ra trong đầu óc non nớt của ông lúc bấy giờ một câu hỏi: "Vì sao quả bóng không có cánh mà vẫn bay được?".
...
-- DUPLICATED contextsS FOR ENRICHMENT (BATCH 2)
-- Duplicate: HOA NGỌC LAN (From Grade 1 to 2)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'HOA NGỌC LAN', 'Đầu hè nhà bà em có một cây hoa ngọc lan.

Thân cây cao, to, vỏ bạc trắng. Lá dày cỡ bàn tay, xanh thẫm. Hoa lan lấp ló qua kẽ lá. Nụ hoa xinh xinh, trắng ngần. Khi nở, cánh hoa xòe ra, duyên dáng. Hương ngọc lan ngan ngát khắp vườn, khắp nhà.

Sáng sáng, bà vẫn cài hoa lan cho bé. Bé thích lắm.', NULL, false, NULL);

-- Duplicate: HOA MAI VÀNG (From Grade 1 to 2)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'HOA MAI VÀNG', 'Nhà bác Khải thật lắm hoa, có vài trăm thứ, rải rác khắp cả khu đất. Các cánh hoa dài ngắn, đủ sắc xanh, đỏ, trắng, vàng, đủ hình đủ dạng.

Mai thích hoa đại, hoa nhài, hoa mai, nhất là hoa mai vàng.', NULL, false, NULL);

-- Duplicate: CHÚ SÓC NGOAN (From Grade 1 to 2)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CHÚ SÓC NGOAN', 'Trong khu rừng nọ có gia đình sóc. Cả nhà sóc đều có bộ lông nâu, óng mượt, đẹp ơi là đẹp! Còn sóc con thì vô cùng xinh xắn, đáng yêu.
...
-- Duplicate: SỰ TÍCH HOA TỈ MUỘI (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'SỰ TÍCH HOA TỈ MUỘI', 'Ngày xưa, có hai chị em Nết và Na mồ côi cha mẹ, sống trong ngôi nhà nhỏ bên sườn núi. Nết thương Na, cái gì cũng nhường em. Đêm đông. Gió ù ù lùa vào nhà, Nết vòng tay ôm em:
...
-- Duplicate: MÙA NƯỚC NỔI (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'MÙA NƯỚC NỔI', 'Mùa này, người làng tôi gọi là mùa nước nổi, không gọi là mùa nước lũ vì nước lên hiền hòa, chứ không dữ dội như những nơi khác. Nước mỗi ngày một dâng lên, cuồn cuộn đầy bờ. Mưa dầm dề, mưa sướt mướt ngày này qua ngày khác.

Rồi đến Rằm tháng Bảy. Dòng sông Cửu Long đã no đầy, lại tràn qua bờ, tràn qua cả mặt đường. Nước trong ao hồ, trong đồng ruộng của mùa mưa hòa lẫn với nước dòng sông Cửu Long.', 'Nguyễn Quang Sáng', false, NULL);

-- Duplicate: NHỮNG CON SAO BIỂN (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'NHỮNG CON SAO BIỂN', 'Một người đàn ông đang dạo bộ trên bãi biển khi chiều xuống. Biển đông người, nhưng ông lại chú ý đến một cậu bé cứ liên tục cúi xuống nhặt thứ gì đó lên rồi thả xuống biển.
...
-- Duplicate: CÂY GẠO (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'CÂY GẠO', 'Mùa xuân, cây gạo gọi đến bao nhiêu là chim. Từ xa nhìn lại, cậy gạo sừng sững như một tháp đèn khổng lồ. Hàng ngàn bông hoa là hàng ngàn ngọn lửa hồng tươi. Hàng ngàn búp nõn là hàng ngàn ánh nến trong xanh. Tất cả đều lóng lánh lung linh trong nắng. Chào mào, sáo sậu, sáo đen…đàn đàn lũ lũ bay đi bay về. Chúng nó gọi nhau, trêu ghẹo nhau, trò chuyện ríu rít. Ngày hội mùa xuân đấy.

Cây gạo già mỗi năm lại trở lại tuổi xuân, càng nặng trĩu những chùm hoa đỏ mọng và đầy tiếng chim hót.', 'Vũ Tú Nam', false, NULL);

-- Duplicate: MÙA VÀNG (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'MÙA VÀNG', 'Thu về, những quả hồng đỏ mọng, những hạt dẻ nâu bóng, những quả na mở to mắt, thơm dìu dịu. Biển lúa vàng ươm. Gió nổi lên và sóng lúa vùng dập dồn trải tới chân trời.
...
-- Duplicate: RỪNG MƠ (From Grade 2 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'RỪNG MƠ', 'Giữa mùa hoa mơ nở
...
-- Duplicate: SÁNG NAY CHIM SẺ NÓI GÌ? (From Grade 4 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'SÁNG NAY CHIM SẺ NÓI GÌ?', 'Đêm nọ, trong giấc mơ, bé Na được ông Bụt ban cho viên ngọc quý nghe được tiếng nói của loài vật. Rồi bé Na vượt suối băng rừng, thoả thích lắng nghe muông thú. Bé Na thích nhất là câu nói của bác Sư Tử. Câu ấy thế này: “Đâu nhất thiết chúng tôi phải nói tiếng người thì loài người mới hiểu được chúng tôi. Chỉ cần một chút yêu thương, gần gũi, các bạn sẽ hiểu chúng tôi. ”
...
-- Duplicate: HOA TÓC TIÊN (From Grade 4 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'HOA TÓC TIÊN', 'Thầy giáo dạy cấp một của tôi có một khoảnh vườn tí tẹo, chỉ độ vài mét vuông. Mọc um tùm với nhau là những thứ quen thuộc: xương sông, lá lốt, bạc hà, kinh giới. Có cả cây ớt lẫn cây hoa hồng lúc nào cũng bừng lên bông hoa rức rỡ. Đặc biệt là viền bốn xung quanh mảnh vườn có hàng tóc tiên, xanh và mềm quanh năm. Chắc là những cô tiên không bao giờ già, tóc không bao giờ bạc nên thứ cỏ này mới có tên gọi như thế.
...
-- Duplicate: SƯ TỬ VÀ KIẾN (From Grade 4 to 3)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'SƯ TỬ VÀ KIẾN', 'Sư Tử chỉ kết bạn với các loài vật nào to khoẻ như mình và cho rằng những con vật bé nhỏ chẳng có ích gì cho nó. Một lần, Kiến Càng đến xin kết bạn với Sư Tử, liền bị Sư Tử xua đuổi.
...
-- Duplicate: CÂY GẠO (From Grade 2 to 5)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'CÂY GẠO', 'Mùa xuân, cây gạo gọi đến bao nhiêu là chim. Từ xa nhìn lại, cậy gạo sừng sững như một tháp đèn khổng lồ. Hàng ngàn bông hoa là hàng ngàn ngọn lửa hồng tươi. Hàng ngàn búp nõn là hàng ngàn ánh nến trong xanh. Tất cả đều lóng lánh lung linh trong nắng. Chào mào, sáo sậu, sáo đen…đàn đàn lũ lũ bay đi bay về. Chúng nó gọi nhau, trêu ghẹo nhau, trò chuyện ríu rít. Ngày hội mùa xuân đấy.

Cây gạo già mỗi năm lại trở lại tuổi xuân, càng nặng trĩu những chùm hoa đỏ mọng và đầy tiếng chim hót.', 'Vũ Tú Nam', false, NULL);

-- Duplicate: KỈ NIỆM MÙA HÈ (From Grade 4 to 5)
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(5, 'TV', 'KỈ NIỆM MÙA HÈ', 'Tôi là một cô bé say mê diều. Nhà tôi ở gần bãi đất rộng, dốc – chỗ bọn con trai trong xóm chọn làm nơi thả diều. Chiều chiều, khi đã nấu cơm xong, tôi có thể đứng lặng hàng giờ để ngắm những cánh diều đủ loại, đủ màu sắc bay trên bầu trời xanh lộng gió.
...
Tôi xúc động nhìn con. Ôi, con gái tôi đã biết chia sẻ niềm vui để em bé kia cũng được vui!', 'Minh Thư', false, NULL);

-- Insert: KIẾN MẸ VÀ CÁC CON
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'KIẾN MẸ VÀ CÁC CON', '<h1 align="center">KIẾN MẸ VÀ CÁC CON</h1>\n\nKiến là một gia đình lớn, Kiến Mẹ có chín nghìn bảy trăm con. Tối nào, Kiến Mẹ cũng tất bật trong phòng ngủ của đàn con để vỗ về và thơm từng đứa:
...
Mỗi chúng ta đều có thể sống như cái chậu nứt: hãy biết tận dụng "vết nứt" của mình.', 'Hạt giống tâm hồn', false, NULL);

-- Insert: ĐƯỜNG BỜ RUỘNG SAU ĐÊM MƯA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'ĐƯỜNG BỜ RUỘNG SAU ĐÊM MƯA', '<h1 align="center">ĐƯỜNG BỜ RUỘNG SAU ĐÊM MƯA</h1>\n\nSau trận mưa đêm qua, đường bờ ruộng trơn như đổ mỡ. Tan học về, các bạn học sinh tổ Đức Thượng phải men theo bờ cỏ mà đi. Các bạn phải lần từng bước một để khỏi trượt chân xuống ruộng.
...
Bạn Sâm đỡ tay em nhỏ: – Cụ để cháu dắt em bé.

Đi khỏi quãng đường lội, bà cụ cảm động nói: – Các cháu biết giúp đỡ người già như thế này là tốt lắm. Bà rất cảm ơn các cháu.

Các em vội đáp: – Thưa cụ, cụ đừng bận tâm ạ. Thầy giáo và cha mẹ thường dạy chúng cháu phải giúp đỡ người già và trẻ nhỏ.', 'Văn lớp 3', false, NULL);

-- Insert: BA ĐIỀU ƯỚC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'BA ĐIỀU ƯỚC', '<h1 align="center">BA ĐIỀU ƯỚC</h1>\n\nNgày xưa, có một chàng thợ rèn tên là Rít. Chàng được một ông tiên tặng cho ba điều ước. Nghĩ trên đời chỉ có vua là sung sướng nhất, Rít ước trở thành vua. Phút chốc, chàng đã đứng trong cung cấm tấp nập người hầu. Nhưng chỉ mấy ngày, chán cảnh ăn không ngồi rồi, Rít bỏ cung điện ra đi.
...
Lò rèn của Rít đỏ lửa, ngày đêm vang tiếng búa đe. Sống giữa sự quý trọng của dân làng, Rít thấy sống có ích mới là điều đáng ước mơ.', 'Truyện cổ Ba-na', false, NULL);

-- Insert: ĐÀ LẠT
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'ĐÀ LẠT', '<h1 align="center">ĐÀ LẠT</h1>\n\nĐà Lạt nằm ở tỉnh Lâm Đồng với khí hậu mát mẻ và những dòng thác nổi tiếng. Những du khách đặt chân đến Đà Lạt sẽ bị choáng ngợp bởi vẻ đẹp mộng mơ và rực rỡ của thành phố này. Nơi đây có thời tiết ấm áp vào buổi sáng nhưng lại se lạnh vào buổi tối nên nó được mới được gọi với cái tên mỹ miều là “thành phố của mùa xuân vĩnh cửu”. Ở Đà Lạt có rất nhiều hồ nước đẹp cùng với những khu vườn bạt ngàn hoa. Những thác nước cao vút tuôn trắng xóa mang vẻ đẹp kì ảo cũng là một điểm thu hút khách du lịch ở nơi đây.

Những du khách đến đây rất thích được cưỡi ngựa vòng quanh hồ Xuân Hương hay thưởng thức những bó hoa tươi được người bán hàng gói cẩn thận. Ngoài ra tại Đà Lạt, khách du lịch trong và ngoài nước có thể tham quan những làng dân tộc, cùng người dân bản địa giao lưu và thưởng thức những món ăn truyền thống như thịt lợn rừng hoặc rượu cần...', 'Sưu tầm', false, NULL);

-- Insert: SỰ TÍCH CÂY VÚ SỮA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'SỰ TÍCH CÂY VÚ SỮA', '<h1 align="center">SỰ TÍCH CÂY VÚ SỮA</h1>\n\nNgày xưa, có một cậu bé ham chơi. Một lần, bị mẹ mắng, cậu vùng vằng bỏ đi. Cậu la cà khắp nơi, chẳng nghĩ đến mẹ ở nhà mỏi mắt chờ mong.
        
Không biết cậu đã đi bao lâu. Một hôm, vừa đói vừa rét, lại bị trẻ lớn hơn đánh, cậu mới nhớ đến mẹ, liền tìm đường về nhà.

Ở nhà, cảnh vật vẫn như xưa, nhưng không thấy mẹ đâu. Cậu khản tiếng gọi mẹ, rồi ôm lấy một cây xanh trong vườn mà khóc. Kỳ lạ thay, cây xanh bỗng run rẩy. Từ các cành lá, những đài hoa bé tí trổ ra, nở trắng như mây. Hoa tàn, quả xuất hiện, lớn nhanh, da căng mịn, xanh óng ánh, rồi chín. Một quả rơi vào lòng cậu.

Môi cậu vừa chạm vào, một dòng sữa trắng trào ra, ngọt thơm như sữa mẹ. Cậu nhìn lên tán lá. Lá một mặt xanh bóng, mặt kia đỏ hoe như mắt mẹ khóc chờ con. Cậu bé oà khóc. Cây xòa cành ôm cậu, như tay mẹ âu yếm vỗ về.

Trái cây thơm ngon, ở vườn nhà cậu, ai cũng thích. Họ đem hạt gieo trồng khắp nơi và gọi đó là cây Vú Sữa.', 'Ngọc Châu', false, NULL);

-- Insert: CÔ GIÁO TÍ HON
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'CÔ GIÁO TÍ HON', '<h1 align="center">CÔ GIÁO TÍ HON</h1>\n\nBé kẹp lại tóc, thả ống quần xuống, lấy cái nón của má đội lên đầu. Nó cố bắt chước dáng đi khoan thai của cô giáo khi bước vào lớp. Mấy đứa nhỏ làm y hệt đám học trò, đứng cả dậy, khúc khích cười chào cô.
...
Thằng Hiển ngọng líu, nói không kịp hai đứa lớn. Cái Anh hai má núng nính, ngồi gọn tròn như củ khoai, bao giờ cũng giành phần đọc xong trước. Cái Thanh mở to đôi mắt hiền dịu nhìn tấm bảng, vừa đọc vừa mân mê mớ tóc mai.', 'Nguyễn Thi', false, NULL);

-- Insert: CHIẾC ÁO LEN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'CHIẾC ÁO LEN', '<h1 align="center">CHIẾC ÁO LEN</h1>\n\nNăm nay, mùa đông đến sớm. Gió thổi từng cơn lạnh buốt. Đã hơn một tuần nay, Lan thấy Hòa có chiếc áo len màu vàng thật đẹp. Áo có dây kéo ở giữa, lại có cả mũ để đội khi có gió lạnh hoặc mưa lất phất. Lan đã mặc thử, ấm ơi là ấm. Đêm ấy, em nói với mẹ là em muốn có một chiếc áo giống như bạn Hòa.

Mẹ đang định mua áo ấm cho cả hai anh em Tuấn, Lan. Thấy con gái nói vậy, mẹ bối rối:
...
Một lúc lâu, bỗng em nghe tiếng anh Tuấn thì thầm với mẹ:
...
Lan ân hận quá. Em muốn ngồi dậy xin lỗi mẹ và anh, nhưng lại xấu hổ vì mình đã vờ ngủ. Áp mặt xuống gối, em mong trời mau sáng để nói với mẹ: "Con không thích chiếc áo ấy nữa. Mẹ hãy mua áo ấm cho cả hai anh em".', 'Từ Nguyên Thạch', false, NULL);

-- Insert: GIỌNG QUÊ HƯƠNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'GIỌNG QUÊ HƯƠNG', '<h1 align="center">GIỌNG QUÊ HƯƠNG</h1>\n\nThuyên và Đồng rời quê đi làm đã mấy năm. Một hôm, hai anh rủ nhau đi chơi thật xa, nhưng đến giữa trưa thì lạc mất đường về. Hai người phải ghé vào cái quán gần đấy để hỏi đường, luôn tiện ăn cho đỡ đói.
        
Trong quán đã có ba thanh niên đang ăn uống vui vẻ. Thuyên và Đồng ngồi vào bàn. Lúc đứng lên trả tiền, Thuyên sờ túi chỉ còn vài đồng. Hai người đang lúng túng, chợt một trong ba thanh niên bước lại gần, nói: "Xin hai anh vui lòng để tôi trả tiền".

Thuyên ngạc nhiên nhìn anh thanh niên. Anh ta cười đôn hậu:
- Dạ, không có chi. Quê tôi cũng ở vùng này. Nghe giọng nói của hai anh, tôi nhớ nhà quá.

Thuyên cảm động. Đồng nắm tay người thanh niên, mắt rớm lệ. Ba người cùng im lặng. Trong phút giây ấy, dường như họ nghe thấy tiếng của đất, của nước, của những người thân yêu từ nơi chôn nhau cắt rốn vọng về.', 'Thanh Tịnh', false, NULL);

-- Insert: ĐẤT QUÝ, ĐẤT YÊU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'ĐẤT QUÝ, ĐẤT YÊU', '<h1 align="center">ĐẤT QUÝ, ĐẤT YÊU</h1>\n\nNgày xưa, có hai người khách du lịch đến nước Ê-ti-ô-pi-a. Họ đi khắp đất nước, thăm đường sá, núi đồi, sông ngòi. Vua nước Ê-ti-ô-pi-a mời họ vào cung điện, mở tiệc chiêu đãi và tặng họ nhiều quà quý.
        
Hôm hai người khách sắp trở về nước, nhà vua tiễn họ ra tận bến tàu. Vua sai người hầu cởi giày của khách ra, rồi sai người cạo sạch đất ở đế giày.

Hai người khách rất ngạc nhiên. Vua bảo:
- Đất nước Ê-ti-ô-pi-a là cha, là mẹ, là anh em ruột thịt của chúng tôi. Chúng tôi đã tiếp các ông như những người khách quý. Nhà vua đã tặng các ông nhiều sản vật hiếm. Nhưng đất Ê-ti-ô-pi-a là thiêng liêng, cao quý nhất. Chúng tôi không thể để các ông mang đi, dù chỉ là một hạt cát nhỏ.', 'Truyện cổ Ê-ti-ô-pi-a', false, NULL);

-- Insert: VẼ QUÊ HƯƠNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'VẼ QUÊ HƯƠNG', '<h1 align="center">VẼ QUÊ HƯƠNG</h1>\n\nBút chì xanh đỏ
Em gọt hai đầu
Em thử hai màu
Xanh tươi, đỏ thắm.
...
Chị ơi bức tranh
Quê ta đẹp quá!', 'Định Hải', false, NULL);

-- Insert: HỘI VẬT
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'HỘI VẬT', '<h1 align="center">HỘI VẬT</h1>\n\nTiếng trống vật nổi lên dồn dập. Người xem đông như nước chảy. Ai cũng náo nức muốn được xem mặt, xem tài ông Cản Ngũ. Người ta chen lấn nhau, quây kín quanh sới vật, nhiều người phải trèo lên những cây cao gần đấy xem cho rõ.

Ngay nhịp trống đầu, Quắm Đen đã lăn xả vào ông Cản Ngũ. Anh vờn bên trái, đánh bên phải, dứ trên, đánh dưới, thoắt biến, thoắt hoá khôn lường. Trái lại, ông Cản Ngũ có vẻ lớ ngớ, chậm chạp. Hai tay ông lúc nào cũng dang rộng, để sát xuống mặt đất, xoay xoay chống đỡ. Keo vật xem chừng chán ngắt.

Ông Cản Ngũ bỗng bước hụt, mất đà chúi xuống. Quắm Đen nhanh như cắt, luồn qua hai cánh tay ông, ôm lấy một bên chân ông bốc lên. Người xem bốn phía reo ồ cả lên. Thôi thế là ông Cản Ngũ ngã rồi, nhất định ngã rồi, có khoẻ bằng voi cũng phải ngã.
...
Ông Cản Ngũ vẫn đứng nghiêng mình nhìn Quắm Đen mồ hôi mồ kê nhễ nhại dưới chân. Lúc lâu, ông mới thò tay xuống nắm lấy khố Quắm Đen, nhấc bổng anh ta lên, nhẹ nhàng như giơ con ếch có buộc sợi rơm ngang bụng vậy.', 'Kim Lân', false, NULL);

-- Insert: NGƯỜI ĐI SĂN VÀ CON VƯỢN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'NGƯỜI ĐI SĂN VÀ CON VƯỢN', '<h1 align="center">NGƯỜI ĐI SĂN VÀ CON VƯỢN</h1>\n\nNgày xưa, có một người đi săn rất tài giỏi. Đã cất nỏ lên là mũi tên bay đi không bao giờ trượt.

Một hôm, người đi săn xách nỏ vào rừng. Bác thấy một con vượn lông xám đang ngồi ôm con trên tảng đá. Bác nhẹ nhàng rút mũi tên bắn trúng vượn mẹ. Vượn mẹ giật bắn người, hết nhìn mũi tên lại nhìn về phía người đi săn bằng đôi mắt căm giận, tay không rời con. Máu ở vết thương chảy ra loang lổ trên ngực.
...
Từ đấy, bác không bao giờ đi săn nữa.', 'Lép Tôn-xtôi', false, NULL);

-- Insert: QUẠT CHO BÀ NGỦ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(3, 'TV', 'QUẠT CHO BÀ NGỦ', '<h1 align="center">QUẠT CHO BÀ NGỦ</h1>\n\nƠi chích chòe ơi!
Chim đừng hót nữa,
Bà em ốm mệt,
Lặng cho bà ngủ.
...
Bà mơ tay cháu
Quạt đầy hương thơm.', 'Thạch Quỳ', false, NULL);

-- Insert: CÓ CÔNG MÀI SẮT, CÓ NGÀY NÊN KIM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CÓ CÔNG MÀI SẮT, CÓ NGÀY NÊN KIM', '<h1 align="center">CÓ CÔNG MÀI SẮT, CÓ NGÀY NÊN KIM</h1>\n\nNgày xưa, có một cậu bé làm việc gì cũng mau chán. Mỗi khi cầm quyển sách, cậu chỉ đọc vài dòng đã ngáp ngắn ngáp dài, rồi bỏ dở. Những lúc tập viết, cậu cũng chỉ nắn nót được mấy chữ đầu, rồi lại viết nguệch ngoạc, trông rất xấu.

Một hôm, trong lúc đi chơi, cậu nhìn thấy một bà cụ già đang ngồi bên tảng đá mài một thỏi sắt. Thấy lạ, cậu tò mò đến gần hỏi:
- Bà ơi, bà làm gì thế?

Bà cụ ngẩng đầu lên, ôn tồn nói:
- Bà mài thỏi sắt này thành một chiếc kim để khâu vá quần áo.

Cậu bé ngạc nhiên:
- Thỏi sắt to như thế, làm sao mà mài thành kim được hả bà?
...
Cậu bé hiểu ra, quay về nhà học bài.', 'Ngụ ngôn', false, NULL);

-- Insert: NGÀY HÔM QUA ĐÂU RỒI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'NGÀY HÔM QUA ĐÂU RỒI', '<h1 align="center">NGÀY HÔM QUA ĐÂU RỒI</h1>\n\nEm cầm tờ lịch cũ:
...
Là ngày qua vẫn còn.', 'Bế Kiến Quốc', false, NULL);

-- Insert: PHẦN THƯỞNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'PHẦN THƯỞNG', '<h1 align="center">PHẦN THƯỞNG</h1>\n\nNa là một cô bé tốt bụng. Ở lớp, ai chơi với Na cũng thấy mến. Na gọt bút chì giúp bạn Lan. Na cho bạn Minh nửa cục tẩy. Nhiều lần, Na làm trực nhật giúp các bạn bị mệt.

Tuy nhiên, Na học chưa giỏi. Cuối năm học, Na không được phần thưởng. Nhưng Na không buồn vì Na thấy mình đã cố gắng rất nhiều.

Buổi lễ tổng kết năm học diễn ra thật tưng bừng. Bất ngờ, cô giáo nói:
- Bây giờ, cô sẽ trao một phần thưởng đặc biệt cho một bạn học sinh đã có nhiều cố gắng, lại hay giúp đỡ bạn bè. Đó là bạn Na.

Cả lớp vỗ tay vang dội. Mẹ của Na lặng lẽ chấm khăn lên đôi mắt đỏ hoe.
Phần thưởng của Na là một chiếc cặp sách màu hồng rất đẹp.', 'Sưu tầm', false, NULL);

-- Insert: LÀM VIỆC THẬT LÀ VUI
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'LÀM VIỆC THẬT LÀ VUI', '<h1 align="center">LÀM VIỆC THẬT LÀ VUI</h1>\n\nQuanh ta, mọi vật, mọi người đều làm việc.
...
Như mọi vật, mọi người, bé cũng làm việc. Bé làm bài, bé đi học. Học xong, bé quét nhà, nhặt rau, chơi với em đõ mẹ.
Bé luôn luôn bận rộn, mà lúc nào công việc cũng đầy vui vẻ.', 'Tô Hoài', false, NULL);

-- Insert: MẨU GIẤY VỤN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'MẨU GIẤY VỤN', '<h1 align="center">MẨU GIẤY VỤN</h1>\n\nLớp học rộng rãi, sáng sủa và sạch sẽ nhưng không biết ai vứt một mẩu giấy ngay giữa lối ra vào. Cô giáo bước vào lớp, mỉm cười:
- Lớp ta hôm nay sạch đẹp quá! Nhưng các em có nhìn thấy mẩu giấy đang nằm ngay giữa cửa kia không?
- Có ạ! - Cả lớp đồng thanh đáp.
- Nào, các em hãy lắng nghe và cho cô biết mẩu giấy đang nói gì nhé! - Cô giáo nói tiếp.

Cả lớp im lặng lắng nghe. Được một lúc, tiếng xì xào nổi lên vì các em không nghe thấy mẩu giấy nói gì cả. Một bạn trai đánh bạo giơ tay xin nói:
- Thưa cô, giấy không nói được đâu ạ!

Bỗng một bạn gái đứng dậy, tiến tới chỗ mẩu giấy, nhặt lên rồi mang bỏ vào sọt rác. Xong xuôi, bạn mới thưa:
- Thưa cô, mẩu giấy bảo em là: "Các bạn ơi! Hãy bỏ tôi vào sọt rác!".

Cả lớp cười rộ lên thích thú. Buổi học hôm ấy thật vui.', 'Sưu tầm', false, NULL);

-- Insert: SÁNG KIẾN CỦA BÉ HÀ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'SÁNG KIẾN CỦA BÉ HÀ', '<h1 align="center">SÁNG KIẾN CỦA BÉ HÀ</h1>\n\nỞ lớp, cũng như ở nhà, bé Hà được coi là một cây sáng kiến. Một hôm, Hà hỏi bố:
- Bố ơi, sao không có ngày của ông bà, bố nhỉ?
- Con hỏi thế nghĩa là sao?
- Ông bà có bao nhiêu là ngày lễ, như ngày Quốc tế phụ nữ, ngày Quốc tế thiếu nhi... mà ông bà lại chưa có ngày nào cả.

Bố cười:
- Ông bà có ngày 1 tháng 10 hàng năm là ngày Quốc tế người cao tuổi đấy thôi.
- Nhưng con muốn có một ngày lễ của riêng ông bà cơ.
- Thế thì con chọn lấy một ngày đi!

Hà suy nghĩ một lát rồi nói:
- Con chọn ngày lập đông, bố nhé! Vì khi trời bắt đầu rét, mọi người cần chăm lo sức khỏe cho các cụ già.
Bố gật đầu: "Sáng kiến của con hay lắm!".', 'Sưu tầm', false, NULL);

-- Insert: BÀ CHÁU
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'BÀ CHÁU', '<h1 align="center">BÀ CHÁU</h1>\n\nNgày xưa, có ba bà cháu tuy nghèo nhưng sống rất vui vẻ, đầm ấm. Một hôm, có cô tiên đi qua cho hai anh em một hạt đào và dặn: "Khi nào bà mất, gieo hạt đào này bên mộ, các cháu sẽ được giàu sang, sung sướng".
        
Bà mất, hai anh em làm theo lời cô tiên dặn. Hạt đào nảy mầm, lớn nhanh như thổi. Cây kết toàn quả vàng, quả bạc. Hai anh em trở nên giàu có, nhưng lúc nào cũng buồn bã vì nhớ bà. 

Cô tiên lại hiện ra. Hai anh em òa khóc, xin cô hóa phép cho bà sống lại, dù có phải sống nghèo khổ như xưa. Cô tiên phất chiếc quạt thần. Lâu đài, ruộng vườn biến mất. Bà hiện ra, móm mém cười, hai tay ôm hai đứa cháu hiếu thảo vào lòng.', 'Truyện cổ tích', false, NULL);

-- Insert: CÂY DỪA
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'CÂY DỪA', '<h1 align="center">CÂY DỪA</h1>\n\nCây dừa xanh tỏa nhiều tàu
...
Mà dừa đủng đỉnh như là đứng chơi.', 'Trần Đăng Khoa', false, NULL);

-- Insert: BÍM TÓC ĐUÔI SAM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(2, 'TV', 'BÍM TÓC ĐUÔI SAM', '<h1 align="center">BÍM TÓC ĐUÔI SAM</h1>\n\nMột hôm, Hà nhờ mẹ tết cho hai bím tóc nhỏ, mỗi bím buộc một cái nơ màu hường. Khi đến trường, mấy bạn gái cùng lớp reo lên: "Ái chà chà! Bím tóc đẹp quá!".

Hà vừa bước vào lớp, Tuấn bỗng sấn tới nắm bím tóc và nói:
- Tớ mệt quá! Cho tớ vịn vào nó một lúc.
Tuấn lớn hơn Hà. Hà không dám chống cự, chỉ đỏ mặt, cúi đầu xuống. Tuấn cứ trêu Hà mãi làm Hà òa khóc.

Thầy giáo bước vào. Thầy hỏi:
- Hà làm sao thế?
Hà nức nở kể lại câu chuyện. Thầy giáo nhìn Tuấn:
- Tại sao em lại trêu bạn?
- Thưa thầy, vì... bím tóc của bạn đẹp quá ạ!

Thầy giáo mỉm cười:
- Tóc bạn đẹp thì em phải khen chứ không được đùa dai như vậy, làm bạn đau. Tuấn phải xin lỗi bạn đi!

Tuấn lúng túng xin lỗi Hà. Vui vẻ trở lại, Hà tung tăng chạy đi.', 'Sưu tầm', false, NULL);

-- Insert: MÈO CON ĐI HỌC
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'MÈO CON ĐI HỌC', '<h1 align="center">MÈO CON ĐI HỌC</h1>\n\nHôm nay trời nắng chang chang
Mèo con đi học chẳng mang thứ gì
Chỉ mang một cái bút chì
Và mang một mẩu bánh mì con con.', 'Phan Thị Vàng Anh', false, NULL);

-- Insert: CÁI TRỐNG TRƯỜNG EM
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CÁI TRỐNG TRƯỜNG EM', '<h1 align="center">CÁI TRỐNG TRƯỜNG EM</h1>\n\nCái trống trường em
Mùa hè cũng nghỉ
Suốt ba tháng liền
Trống nằm ngẫm nghĩ.
...
Tùng! Tùng! Tùng! Tùng!
Vào năm học mới
Rộn vang tưng bừng.', 'Thanh Hào', false, NULL);

-- Insert: BÀN TAY MẸ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'BÀN TAY MẸ', '<h1 align="center">BÀN TAY MẸ</h1>\n\nBình yêu nhất là đôi bàn tay mẹ. Hằng ngày, đôi bàn tay của mẹ phải làm biết bao nhiêu là việc.
Đi làm về, mẹ lại đi chợ, nấu cơm. Mẹ còn tắm cho em bé, giặt một chậu tã lót đầy.
Bình yêu lắm đôi bàn tay rám nắng, các ngón tay gầy gầy, xương xương của mẹ.', 'Tạ Hữu Yên', false, NULL);

-- Insert: NGÔI NHÀ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'NGÔI NHÀ', '<h1 align="center">NGÔI NHÀ</h1>\n\nEm yêu nhà em
Hàng xoan trước ngõ
Hoa xao xuyến nở
Như mây từng chùm.
...
Gỗ tre mộc mạc
Như yêu đất nước
Bốn mùa chim ca.', 'Tô Hà', false, NULL);

-- Insert: QUÀ CỦA BỐ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'QUÀ CỦA BỐ', '<h1 align="center">QUÀ CỦA BỐ</h1>\n\nBố em là bộ đội ở đảo xa. Bố gửi cho em bao nhiêu là quà.
Bố gửi nghìn cái nhớ, gửi nghìn cái thương. Bố gửi nghìn lời chúc, gửi nghìn cái hôn.
Bố gửi cho em cái nghìn trùng xa cách.
Nhưng em vẫn thấy bố ở rất gần. Vì bố luôn ở trong tim em.', 'Phạm Đình Ân', false, NULL);

-- Insert: LÀM ANH
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'LÀM ANH', '<h1 align="center">LÀM ANH</h1>\n\nLàm anh khó đấy
Phải đâu chuyện đùa
Với em bé gái
Phải người lớn cơ.
...
Nhưng mà thật vui
Ai yêu em bé
Thì làm được thôi.', 'Phan Thị Thanh Nhàn', false, NULL);

-- Insert: HOA NGỌC LAN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'HOA NGỌC LAN', '<h1 align="center">HOA NGỌC LAN</h1>\n\nỞ ngay đầu hè nhà bà em có một cây hoa ngọc lan. Thân cây cao, to, vỏ bạc trắng. Lá dày, cỡ bằng bàn tay, xanh thẫm.
Hoa lan lấp ló qua kẽ lá. Nụ hoa xinh xinh, trắng ngần. Khi hoa nở, cánh xoè ra duyên dáng.
Hương lan thơm ngát, tỏa khắp vườn, khắp nhà.
Vào mùa lan, sáng nào bà cũng cài một búp lan lên mái tóc em.', 'Sưu tầm', false, NULL);

-- Insert: MƯU CHÚ SẺ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'MƯU CHÚ SẺ', '<h1 align="center">MƯU CHÚ SẺ</h1>\n\nBuổi sớm, một con mèo chộp được một chú sẻ. Sẻ hoảng lắm, nhưng nó nén sợ, lễ phép nói:
- Thưa anh, tại sao một người sạch sẽ như anh, trước khi ăn sáng lại không rửa mặt?
Nghe vậy, mèo đặt sẻ xuống, đưa hai chân lên vuốt râu, xoa mép. Thế là sẻ vụt bay đi.
Mèo rất tức giận nhưng đã muộn mất rồi.', 'Sưu tầm', false, NULL);

-- Insert: BÁC ĐƯA THƯ
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'BÁC ĐƯA THƯ', '<h1 align="center">BÁC ĐƯA THƯ</h1>\n\nBác đưa thư trao cho Minh một bức thư. Đúng là thư của bố rồi. Minh mừng quýnh. Minh muốn chạy thật nhanh vào nhà khoe với mẹ.
Nhưng em chợt thấy bác đưa thư mồ hôi nhễ nhại. Minh chạy vội vào nhà, rót một cốc nước mát lạnh. Hai tay bưng ra, em lễ phép:
- Cháu mời bác uống nước ạ!', 'Trần Đăng Khoa', false, NULL);

-- Insert: ĐẦM SEN
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'ĐẦM SEN', '<h1 align="center">ĐẦM SEN</h1>\n\nĐầm sen ở ven làng. Lá sen màu xanh mát. Lá cao, lá thấp chen nhau, phủ kín mặt đầm.
Hoa sen đua nhau nở. Cánh hoa đỏ nhạt xoè ra, phô đài sen và nhị vàng.
Hương sen ngan ngát, thanh khiết. 
Đài sen già thì dẹt lại, xanh thẫm.
Bác Tâm đi thuyền thúng vào giữa đầm hái hoa, hái gương sen về.', 'Tập đọc lớp 1', false, NULL);

-- Insert: CÂY BÀNG
INSERT INTO contexts (grade, subject, title, content, author, from_book, owner_id) VALUES 
(1, 'TV', 'CÂY BÀNG', '<h1 align="center">CÂY BÀNG</h1>\n\nNgay giữa sân trường, sừng sững một cây bàng.
...
Thu đến, từng chùm quả chín vàng. Trong quả có nhân hạt ăn bùi bùi.', 'Đoàn Giỏi', false, NULL);
